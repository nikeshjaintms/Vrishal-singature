...
import { getMultiFd } from '../../../../Store/MutipleDrawing/MultiFd/getMultiFd';
...
const FinalDimension = () => {
    ...
    useEffect(() => {
        if (disable === true) {
            dispatch(getMultiFd({page: currentPage,limit,search}));
            setDisable(false);
        }
        else{
            dispatch(getMultiFd({page: currentPage,limit,search}));
    ...
    const entity = useSelector((state) => state?.getMultiFd?.user?.data?.data);
    const pagination = useSelector((state) => state?.getMultiFd?.user?.data?.pagination) || {};
    ...
    const commentsData = useMemo(() => {
        ...
        //         (fd) =>
        //             fd?.report_no?.toLowerCase()?.includes(search?.toLowerCase())
        //     );
        // }
        if (status) {
                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                <ul className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active">Final Dimension Offer List</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div className="row align-items-center">
                                                <div className="col">
                                                    <div className="doctor-table-blk">
                                                        <h3>Final Dimension Offer List</h3>
                                                        <div className="doctor-search-blk">
                                                            ...
                                                            <div className="add-group">
                                                                {localStorage.getItem('ERP_ROLE') === PRODUCTION && (
                                                                    <Link to="/user/project-store/manage-final-dimension-offer"
                                                            ...
                                                            <td className="text-end">
                                                                <div className="dropdown dropdown-action">
                                                                    ...
                                                                    <div className="dropdown-menu dropdown-menu-end">
                                                                        <button type='button' className="dropdown-item" onClick={() => navigate('/user/project-store/manage-final-dimension-offer', { state: elem })}>
