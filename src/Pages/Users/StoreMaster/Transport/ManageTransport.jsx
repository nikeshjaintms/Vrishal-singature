...
const ManageTransport = () => {
      ...
      dispatch(addTransport(formData))
        .then((res) => {
          ...
          if (res.payload.success === true) {
            navigate('/user/project-store/transport-management');
            setTransport({
              name: "",
              address: "",
              phone: "",
  ...
  const handleReset = () => {
    setTransport({ name: "", email: "", phone: "", address: "" })
    setError({})
  }
  return (
            ...
            <div className="row">
              <div className="col-sm-12">
                <ul className="breadcrumb">
                  ...
                  <li className="breadcrumb-item"><Link to="/user/project-store/transport-management">Transport List</Link></li>
                  <li className="breadcrumb-item"><i className="feather-chevron-right"></i></li>
