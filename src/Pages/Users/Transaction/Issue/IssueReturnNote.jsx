...
useEffect(() => {
  dispatch(
    ...
    const entity = useSelector((state) => state.getMultipleIssueReturn?.issues?.data);
    const pagination = useSelector((state) => state.getMultipleIssueReturn?.issues?.pagination);
...
console.log("commentsData",commentsData);
    ...
    const handleDownload = (option) => {
        ...
        if (ispdf) {
            PdfDownloadErp({ apiMethod: 'post', url: 'download-multi-issue-return', body: bodyFormData });
    ...
    // }
const handleRefresh = () => {
  dispatch(getMultipleIssueReturn({ limit, page: currentPage , project }));
};
                                                        ...
                                                        <div className="doctor-search-blk">
                                                            ...
                                                            <div className="add-group">
                                                                {localStorage.getItem('ERP_ROLE') === `${PRODUCTION}` &&
                                                                    <Link to="/user/project-store/manage-issue-return"
                                                            ...
                                                            <td className="text-end">
                                                                <div className="dropdown dropdown-action">
                                                                    ...
                                                                    <div className="dropdown-menu dropdown-menu-end">
                                                                        <button type='button' className="dropdown-item" onClick={() => navigate('/user/project-store/manage-issue-return', { state: elem } )}><i
