    ...
    formValues.forEach((values, index) => {
      ...
      if (!values.heat_no_data || values.heat_no_data.length === 0) {
        ...
        values.heat_no_data.forEach((heatData, heatIndex) => {
          ...
          if (!heatData.heat_no) {
            heatError.heat_no = 'Heat No is required';
            hasError = true;
          }
                  ...
                  {data?.items?.map((elem, i) =>
                    <form>
                      ...
                      <div className='row'>
                        ...
                        <div className='col-12 col-md-4 col-xl-4'>
                          <div className="input-block local-forms">
                            <label>Inspected Qty.(kg) <span className="login-danger">*</span></label>
                            ...
                            <div className="col-12 col-md-2">
                              <div className="input-block local-forms">
                                ...
                                <input
                                  ...
                                  value={heatData.heat_no}
                                  onChange={(e) => updateHeatNoData(i, heatIndex, 'heat_no', e.target.value)}
                                />
                                {errors[i]?.heat_no_data?.[heatIndex]?.heat_no && (
                                  <div className="error">{errors[i]?.heat_no_data[heatIndex]?.heat_no}</div>
                                )}
                              </div>
                            </div>
                            <div className="col-12 col-md-2">
