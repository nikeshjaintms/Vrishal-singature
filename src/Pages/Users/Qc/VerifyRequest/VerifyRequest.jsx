...
const debouncedSearch = useDebounce(search, 500);
  ...
  const getOffer = () => {
    const myurl = `${V_URL}/user/get-purchase-offer?page=${currentPage}&limit=${limit}&projectId=${projectId}&search=${search}`;
                                ...
                                <td>
                                  {elem.status === 4 ? (
                                    ...
                                    <PackageCheck
                                      ...
                                      onClick={() =>
                                        navigate('/user/project-store/manage-verify-request', {
                                          state: elem,
                                        })
                                      }
                                    />
