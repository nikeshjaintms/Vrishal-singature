            ...
            <div className="row">
              <div className="col-sm-12">
                <ul className="breadcrumb">
                  ...
                  <li className="breadcrumb-item"><Link to="/user/project-store/surface-primer-management">Surface Preparation & Primer List</Link></li>
                  <li className="breadcrumb-item"><i className="feather-chevron-right"></i></li>
                ...
                <div className="card-body">
                  <div className="doctor-submit text-end">
                    {localStorage.getItem('ERP_ROLE') === PRODUCTION ? (
                      ...
                      <button className="btn btn-primary" type='button' onClick={() => navigate('/user/project-store/surface-primer-management')}>
                        Back
                      </button>
                    )}
                  </div>
