...
import { getUserUtClearance } from '../../../../Store/Store/Ndt/UT/UtClearance';
...
const GetUtClearance = () => {
    ...
    useEffect(() => {
        if (disable === true) {
            dispatch(getUserUtClearance())
            setDisable(false);
        }
    }, [dispatch, disable]);

    const entity = useSelector((state) => state.getUserUtClearance?.user?.data);
    ...
    const handleDownloadIns = (elem) => {
        ...
        PdfDownloadErp({ apiMethod: 'post', url: 'one-ut-report-download', body: bodyFormData });
    }
                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                <ul className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active">Ultrasonic Test Clearance List</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                                        ...
                                                        <div className="doctor-search-blk">
                                                            ...
                                                            <div className="add-group">
                                                                {localStorage.getItem('ERP_ROLE') === QC && (
                                                                    <Link to="/user/project-store/manage-ut-clearance"
                                                            ...
                                                            <td className="text-end">
                                                                <div className="dropdown dropdown-action">
                                                                    ...
                                                                    <div className="dropdown-menu dropdown-menu-end">
                                                                        <button type='button' className="dropdown-item" onClick={() => navigate('/user/project-store/manage-ut-clearance', { state: elem })}><i
