...
import { getUserLptClearance } from '../../../../Store/Store/Ndt/LPT/LptClearance';
...
const LptClearance = () => {
    ...
    useEffect(() => {
        if (disable === true) {
            dispatch(getUserLptClearance());
            setDisable(false);
        }
    }, [dispatch, disable]);

    const entity = useSelector((state) => state.getUserLptClearance?.user?.data);
    ...
    const handleDownloadIns = (elem) => {
        ...
        PdfDownloadErp({ apiMethod: 'post', url: 'one-lpt-report-download', body: bodyFormData });
    }
                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                <ul className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active">Liquid Penetrant Testing Clearance List</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                                        ...
                                                        <div className="doctor-search-blk">
                                                            ...
                                                            <div className="add-group">
                                                                {localStorage.getItem('ERP_ROLE') === QC && (
                                                                    <Link to="/user/project-store/manage-lpt-clearance"
