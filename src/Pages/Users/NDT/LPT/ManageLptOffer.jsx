                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                <ul className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item"><Link to="/user/project-store/lpt-offer-management">Liquid Penetrant Testing Offer List</Link></li>
                                    <li className="breadcrumb-item"><i className="feather-chevron-right"></i></li>
                                    ...
                                    <div className="col-12">
                                        <div className="doctor-submit text-end">
                                            {localStorage.getItem('ERP_ROLE') === QC ? (
                                                ...
                                                <button type="button" className="btn btn-primary submit-form me-2" onClick={() => navigate('/user/project-store/lpt-offer-management')}>
                                                    Back
                                                </button>
                                            )}
                                        </div>
