                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                <ul className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item"><Link to="/user/project-store/mpt-offer-management">Magnetic Particle Testing Offer List</Link></li>
                                    <li className="breadcrumb-item"><i className="feather-chevron-right"></i></li>
                                    <li className="breadcrumb-item active">{data?._id ? 'Edit' : 'Add'} Magnetic Particle Testing Offer List</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div className="doctor-submit text-end">
                                            {localStorage.getItem('ERP_ROLE') === QC ? (
                                                <button type="button"
                                                    ...
                                                    disabled={disable}>{disable ? "Processing..." : "Generate MPT Offer"}</button>
                                            ) : (
                                                <button type='button' className='btn btn-primary' onClick={() => navigate('/user/project-store/mpt-offer-management')}>
                                                    Back
                                                </button>
                                            )}
                                        </div>
