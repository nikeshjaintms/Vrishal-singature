        ...
        <div className={`main-wrapper ${isSidebarOpen ? 'slide-nav' : ''}`}>
            ...
            <div className="page-wrapper">
                <div className="content">
                    ...
                    <NdtOfferHeader name={'Magnetic Particle Testing Offer List'} />

                    {disable === false ? (
                        <NdtOfferTable
                            name={'Magnetic Particle Testing Offer List'}
                            url={'/user/project-store/manage-mpt-offer'}
