...
const ManagePaintManufacture = () => {
  ...
  const handleSubmit = () => {
    ...
    setError('');
    setDisable(true);
    const myurl = `${V_URL}/user/manage-paint-manufacturer`;
    ...
    axios({
      ...
      if (response.data.success === true) {
        navigate('/user/project-store/paint-manufacture-management')
            ...
            <div className="row">
              <div className="col-sm-12">
                <ul className="breadcrumb">
                  ...
                  <li className="breadcrumb-item"><Link to="/user/project-store/paint-manufacture-management">Paint Manufacturer List</Link></li>
                  <li className="breadcrumb-item"><i className="feather-chevron-right"></i></li>
