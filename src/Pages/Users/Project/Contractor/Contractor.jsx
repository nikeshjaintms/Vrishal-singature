...
const Contractor = () => {
  ...
  useEffect(() => {
    ...
    setEntity(findProject?.contractor);
  }, [projectData]);
    ...
    if (search) {
      computedComments = computedComments.filter(
        (i) =>
          ...
          i.mobile?.toString()?.toLowerCase()?.includes(search?.toLowerCase()) ||
  ...
  const handleDelete = (id, title) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        const myurl = `${V_URL}/user/delete-contractor`;
            ...
            <div className="row">
              <div className="col-sm-12">
                <ul className="breadcrumb">
                  ...
                  <li className="breadcrumb-item active">Contractor Master List</li>
                </ul>
              </div>
            </div>
          </div>
                          ...
                          <div className="doctor-table-blk">
                            ...
                            <div className="doctor-search-blk">
                              ...
                              <div className="add-group">
                                {/* <Link to="/user/project-store/manage-contractor-master"
                        ...
                        <tbody>
                          {commentsData?.map((elem, i) =>
                            <tr key={elem?._id}>
                              ...
                              <td>{elem?.conId?.name}</td>
                              <td>{elem?.conId?.mobile}</td>
                              <td>{elem?.conId?.email}</td>
                              <td className='status-badge'>
                                {elem?.conId?.status === true ? (
                                ...
                                <div className="dropdown dropdown-action">
                                  ...
                                  <div className="dropdown-menu dropdown-menu-end">
                                    <button type='button' className="dropdown-item"
                                      onClick={() => navigate('/user/project-store/manage-contractor-master', { state: elem })}><i
