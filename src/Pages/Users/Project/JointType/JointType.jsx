...
const JointType = () => {
  ...
  const entity = useSelector((state) => state?.getUserJointType?.user?.data);
  ...
  const handleDelete = (id, title) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        const myurl = `${V_URL}/user/delete-joint-type`;
                          ...
                          <div className="doctor-table-blk">
                            ...
                            <div className="doctor-search-blk">
                              ...
                              <div className="add-group">
                                <WeldingAuth>
                                  <Link to="/user/project-store/manage-joint-type"
                                  ...
                                  <div className="dropdown dropdown-action">
                                    ...
                                    <div className="dropdown-menu dropdown-menu-end">
                                      <button type='button' className="dropdown-item"
                                        onClick={() => navigate('/user/project-store/manage-joint-type', { state: elem })}><i
