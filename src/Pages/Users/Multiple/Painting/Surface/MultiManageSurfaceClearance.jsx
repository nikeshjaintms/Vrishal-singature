...
const MultiManageSurfaceClearance = () => {
    ...
    const handleSubmit = () => {
        if (validateSurfaceData.current && validateSurfaceData.current()) {
            ...
            bodyFormData.append('isMIO', releaseType === "MIO");
            bodyFormData.append('isIrn', releaseType === "IRN");
            ...
            <div className="page-wrapper">
                <div className="content">
                    ...
                    <SubmitButton disable={disable} handleSubmit={handleSubmit} 
                        ...
                        link={'/user/project-store/surface-clearance-management'} 
                        buttonName={'Generate Surface & Primer Clearance'} 
                    />
