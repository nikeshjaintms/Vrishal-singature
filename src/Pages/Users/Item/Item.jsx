...
const debouncedSearch = useDebounce(search, 500);
    useEffect(() => {
        // if (disable === true) {
            dispatch(getAdminItem({ is_main: false, currentPage,limit, search:debouncedSearch })).finally(() => setDisable(false));
            // setDisable(false);
        // }
    }, [dispatch, disable,debouncedSearch]);

    const entity = useSelector((state) => state?.getAdminItem?.user?.data?.data);
    const pagination = useSelector((state) => state?.getAdminItem?.user?.data?.pagination);
                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                <ul className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active">Section Details List</li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
/>
                                                            ...
                                                            <div className="add-group">
                                                                <PlanningMaterialAuth>
                                                                    <Link to="/user/project-store/manage-item"
                                                ...
                                                <div className="pageDropDown col-auto text-end float-end ms-auto download-grp">
                                                    <div className="add-group" style={{ marginRight: "10px" }}>
                                                        <DownloadFormat url={`${V_URL}/user/download-items`} fileName="Items" />
                                                                ...
                                                                <td className="text-end">
                                                                    <div className="dropdown dropdown-action">
                                                                        ...
                                                                        <div className="dropdown-menu dropdown-menu-end">
                                                                            <button type='button' className="dropdown-item" onClick={() => navigate('/user/project-store/manage-item', { state: elem })}><i
