  ...
  const handleSubmit = () => {
    if (validation()) {
      ...
      dispatch(addItem(formData))
        .then((res) => {
          console.log(res, 'response front')
          if (res.payload.success === true) {
            navigate('/user/project-store/item-management')
            ...
            <div className="row">
              <div className="col-sm-12">
                <ul className="breadcrumb">
                  ...
                  <li className="breadcrumb-item"><Link to="/user/project-store/item-management">Section Details List</Link></li>
                  <li className="breadcrumb-item"><i className="feather-chevron-right"></i></li>
