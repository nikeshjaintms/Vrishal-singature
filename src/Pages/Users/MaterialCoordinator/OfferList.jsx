...
useEffect(() => {
  dispatch(getUserOffer()); //  CALL this only once (e.g. on mount)
}, []);
    ...
    const handleSendQc = (id, title) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const myurl = `${V_URL}/user/send-offer-qc`;
                                                            ...
                                                            <td className="text-end">
                                                                <div className="dropdown dropdown-action">
                                                                    ...
                                                                    <div className="dropdown-menu dropdown-menu-end">
                                                                           <button type='button' className="dropdown-item" onClick={() => navigate('/user/project-store/edit-offer', { state: elem })}>
                                                                            <i  className="fa-solid fa-pen-to-square m-r-5"></i>
                                                                            Edit
                                                                        </button>
                                                                        <button type='button' className="dropdown-item" onClick={() => navigate('/user/project-store/view-offered-item', { state: elem })}>
