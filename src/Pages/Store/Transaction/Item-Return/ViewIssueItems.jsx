...
const ViewIssueItems = () => {
    const getOneIsseItem = useSelector((state => state?.getIssueItems?.data?.data))
    const headers = {
        'Name': 'item_name',
        'Unit': 'unit',
        'M.code': 'm_code',
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                await dispatch(getIssueItems({ id: data?._id }));
                setDisable(false)
            } catch (error) {
                setDisable(false)
                console.log(error, '!!')
                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                <ul className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active">View Issue Items</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div className="col-12 text-end">
                                        <div className="doctor-submit text-end">
                                            <button
                                                ...
                                                onClick={() => navigate('/main-store/user/issue-purchase-management')}>
                                                Back
                                            </button>
                                        </div>
                                    </div>
