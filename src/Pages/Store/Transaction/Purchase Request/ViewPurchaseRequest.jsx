...
const ViewPurchaseRequest = () => {
    ...
    useEffect(() => {
        ...
        if (disable === true) {
            setEntity([]);
            getSinglePurchaseRrequest({ id: data?._id });
        }
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                await dispatch(getSinglePurchaseRrequest({ id: data?._id }))
                setDisable(false)
            } catch (error) {
                console.log(error, '!!')
                setDisable(false)
                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                <ul className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item">
                                        <Link to="/main-store/user/getPurchaseRequest">View Purchase Request</Link>
                                    </li>
                                    <li className="breadcrumb-item">
                                        <i className="feather-chevron-right"></i>
                                    </li>
