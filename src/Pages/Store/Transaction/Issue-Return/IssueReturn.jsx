...
const IssueReturn = () => {
    ...
    const fetchData = () => {
        ...
        dispatch(getIssueReturn({ formData: bodyFormData }));
        setDisable(false);
    };
    ...
    const entity = useSelector((state => state?.getIssueReturn?.data?.data))
    ...
    const handleDownloadPdf = (id) => {
        ...
        DownloadPdf({ apiMethod: 'post', url: 'isr-download-pdf', body: bodyFormData })
    }
    const handleSDDownloadPdf = (id) => {
        const bodyFormData = new URLSearchParams();
        bodyFormData.append('id', id);
        bodyFormData.append('print_date', true);
        DownloadPdf({ apiMethod: 'post', url: 'isr-sort-download-pdf', body: bodyFormData })
    }
    const handleLDDownloadPdf = (id) => {
        const bodyFormData = new URLSearchParams();
        bodyFormData.append('id', id);
        bodyFormData.append('print_date', true);
        DownloadPdf({ apiMethod: 'post', url: 'isr-long-download-pdf', body: bodyFormData })
    }
