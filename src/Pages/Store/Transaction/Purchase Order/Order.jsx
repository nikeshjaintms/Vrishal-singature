...
import { getPurchaseOrder } from "../../../../Store/Store/MainStore/PurchaseOrder/getPurchaseOrder";
...
const Order = () => {
    ...
    const fetchData = () => {
        ...
        dispatch(getPurchaseOrder({ formData: bodyFormData }));
        setDisable(false);
    };
    ...
    const entity = useSelector((state => state?.getPurchaseorder?.data?.data))
    ...
    const handleDelete = (id, title) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const myurl = `${V_URL}/user/delete-po`;
                var bodyFormData = new URLSearchParams();
                bodyFormData.append("id", id);
                bodyFormData.append("tag_number", 15);
                                                    ...
                                                    <div className="doctor-table-blk">
                                                        ...
                                                        <div className="doctor-search-blk">
                                                            ...
                                                            <div className="add-group">
                                                                <Link to="/main-store/user/manage-order" className="btn btn-primary add-pluss ms-2"
                                                            ...
                                                            <td className="text-end">
                                                                <div className="dropdown dropdown-action">
                                                                    ...
                                                                    <div className="dropdown-menu dropdown-menu-end">
                                                                        <button type='button' className="dropdown-item" onClick={() => navigate(`/main-store/user/view-order`, { state: elem })}><i
                                                                            className="fa-solid fa-eye m-r-5"></i>
                                                                            View</button>
                                                                        {
                                                                            elem.status !== 4 && <>
                                                                                <button type='button' className="dropdown-item" onClick={() => navigate(`/main-store/user/order-manage`, { state: elem })}><i
                                                                        ...
                                                                        <button type='button' className="dropdown-item d-flex align-items-center" onClick={() => handleDownload(elem?._id, elem.voucher_no)} ><i className="fa-solid fa-download"></i> Download Report</button>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
