...
const ManualItemModel = ({ show, editeMode, EditItem, handleClose, handleAddMore, handleSave }) => {
    ...
    return (
        <Modal show={show} onHide={handleModalClose} size="lg" backdrop="static" keyboard={false}>
            <Modal.Header closeButton>
                <Modal.Title>{editeMode ? 'Edit Item' : 'Add Item'}</Modal.Title>
            </Modal.Header>
            <Modal.Body>
                <div className="row">
            ...
            <Modal.Footer>
                ...
                <div className="col-12 text-end">
                    ...
                    <button type="button" className="btn btn-primary ms-2" onClick={() => saveItem("add")}>Save</button>
                    {
                        !editeMode && (
                            <button type="button" className="btn btn-primary ms-2" onClick={() => saveItem("addMore")}>Add More</button>
                        )
                    }
                </div>
            </Modal.Footer>
...
export default ManualItemModel