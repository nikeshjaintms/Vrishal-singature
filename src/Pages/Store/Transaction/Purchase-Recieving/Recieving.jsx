...
import { getPurchaseReciecing } from '../../../../Store/Store/MainStore/PurchaseRecieving/GetPurchaseRecieving';
...
const Recieving = () => {
    ...
    const fetchData = () => {
        ...
        dispatch(getPurchaseReciecing({ formData: bodyFormData }))
        setDisable(false);
    };
    ...
    const entity = useSelector((state) => state?.getPurchaseRecieving?.data?.data);
    ...
    const handleDelete = (id, title) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const myurl = `${V_URL}/user/delete-pu`;
                                                    ...
                                                    <div className="doctor-table-blk">
                                                        ...
                                                        <div className="doctor-search-blk">
                                                            ...
                                                            <div className="add-group">
                                                                <Link
                                                                    to="/main-store/user/manage-recieving"
                                        ...
                                        <div className="table-responsive">
                                            <table className="table border-0 custom-table comman-table  mb-0">
                                                <thead>
                                                    <tr>
                                                        <th>Sr No.</th>
                                                        <th className="right-align">PU Date</th>
                                                        <th className="right-align" >PU No.</th>
                                                            ...
                                                            <td className="text-end">
                                                                <div className="dropdown dropdown-action">
                                                                    ...
                                                                    <div className="dropdown-menu dropdown-menu-end">
                                                                        <button type='button' className="dropdown-item" onClick={() => navigate(`/main-store/user/view-recieving`, { state: elem })}><i
                                                                            className="fa-solid fa-eye m-r-5"></i>
                                                                            View</button>
                                                                        <button type='button' className="dropdown-item" onClick={() => navigate(`/main-store/user/recieving-manage`, { state: elem })}><i
                                                                        ...
                                                                        <button type='button' className="dropdown-item" onClick={() => handleDownload(elem?._id, elem.voucher_no)} ><i className="fa-solid fa-download"></i> Download Report</button>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
