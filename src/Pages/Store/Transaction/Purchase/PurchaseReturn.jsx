...
import { getReturn } from "../../../../Store/Store/Order/Return";
  ...
  return (
    <div className={`main-wrapper ${isSidebarOpen ? "slide-nav" : ""}`}>
                                ...
                                <div className="dropdown dropdown-action">
                                  ...
                                  <div className="dropdown-menu dropdown-menu-end">
                                    <button type='button' className="dropdown-item" onClick={() => navigate(`/main-store/user/view-purchase-return`, { state: elem })}><i
                                      ...
                                      View</button>
                                    <button type='button' className="dropdown-item" onClick={() => navigate(`/main-store/user/manage-pr`, { state: elem })}><i
      ...
      {startDownload &&
        <PDFDownload
          method="POST"
          url="/user/one-ms-transaction-download"
          payload={payload}
        />}
    </div>
  );
