...
const Header = ({ handleOpen }) => {
    ...
    const fullFirmName = localStorage.getItem('PAY_USER_FIRM_NAME');
    const extractedFirmName = fullFirmName ? fullFirmName.split(' Group of Companies.')[0] : '';
    return (
        <div className="header">
            <div className="header-left">
                <Link to="/main-store/user/dashboard" className="logo">
            ...
            <span className='mob-view' style={{ lineHeight: "60px", paddingLeft: "15px" }}>
                {loading ? (
                    ...
                    <span style={{ fontWeight: "500", fontSize: "18px" }}>
                        VRISHAL ENGINEERING PRIVATE LIMITED & Vishal Enterprise / {moment(localStorage.getItem('PAY_USER_START_YEAR')).format('YYYY')}-{moment(localStorage.getItem('PAY_USER_END_YEAR')).format('YYYY')}
                    </span>
                )}
            </span>
                        ...
                        <div className="drop-scroll">
                            <ul className="notification-list">
                                ...
                                <li className="notification-message">
                                    <a href="activities.html">
                                        <div className="media">
                                            <span className="avatar">V www</span>
                                            <div className="media-body">
            ...
            <div className="dropdown mobile-user-menu float-end">
                ...
                <div className="dropdown-menu dropdown-menu-end">
                    <Link className="dropdown-item" to="/main-store/user/edit-profile">My Profile</Link>
                    <button type='button' className="dropdown-item" onClick={handleLogout}>Logout</button>
                </div>
            </div>
        </div>
