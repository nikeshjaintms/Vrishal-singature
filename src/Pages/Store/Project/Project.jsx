...
const Project = () => {
        ...
        if (search) {
            computedComments = computedComments.filter(
                (pro) =>
                    ...
                    pro.label?.toLowerCase()?.includes(search?.toLowerCase())
            );
        }
    ...
    const getProject = () => {
        const myurl = `${V_URL}/user/get-admin-project`;
        axios({
            method: "get",
            url: myurl,
    ...
    const handleDelete = (id, title) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                const myurl = `${V_URL}/user/delete-project`;
                                                    ...
                                                    <div className="doctor-table-blk">
                                                        ...
                                                        <div className="doctor-search-blk">
                                                            ...
                                                            <div className="add-group">
                                                                <Link to="/main-store/user/manage-project"
                                                            ...
                                                            <td className="text-end">
                                                                <div className="dropdown dropdown-action">
                                                                    ...
                                                                    <div className="dropdown-menu dropdown-menu-end">
                                                                        <button type='button' className="dropdown-item" onClick={() => navigate('/main-store/user/manage-project', { state: elem })}><i
