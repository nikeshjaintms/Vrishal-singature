      ...
      dispatch(addTransport(formData))
        .then((res) => {
          ...
          if (res.payload.success === true) {
            navigate('/main-store/user/transport-management');
            setTransport({
              name: "",
              address: "",
              phone: "",
            ...
            <div className="row">
              <div className="col-sm-12">
                <ul className="breadcrumb">
                  ...
                  <li className="breadcrumb-item"><Link to="/main-store/user/transport-management">Transport List</Link></li>
                  <li className="breadcrumb-item"><i className="feather-chevron-right"></i></li>
