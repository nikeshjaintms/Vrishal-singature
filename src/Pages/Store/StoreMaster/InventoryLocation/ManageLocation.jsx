      ...
      dispatch(addLocation(formData))
        .then((res) => {
          ...
          if (res.payload.success === true) {
            navigate('/main-store/user/inventory-location-management');
            setInventoryLocation({
              name: "",
              address: ""
            });
            ...
            <div className="row">
              <div className="col-sm-12">
                <ul className="breadcrumb">
                  ...
                  <li className="breadcrumb-item"><Link to="/main-store/user/inventory-location-management">Inventory Location List</Link></li>
                  <li className="breadcrumb-item"><i className="feather-chevron-right"></i></li>
