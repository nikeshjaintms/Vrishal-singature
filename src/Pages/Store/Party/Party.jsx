...
const Party = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      if (disable === true) {
        try {
          await dispatch(getAdminParty({ storeType: '1', is_main: true}))
          setDisable(false);
        } catch (error) {
          console.log(error, '!!')
          setDisable(false);
                          ...
                          <div className="doctor-table-blk">
                            ...
                            <div className="doctor-search-blk">
                              ...
                              <div className="add-group">
                                <Link to="/main-store/user/manage-party"
                              ...
                              <td className="text-end">
                                <div className="dropdown dropdown-action">
                                  ...
                                  <div className="dropdown-menu dropdown-menu-end">
                                    <button type='button' className="dropdown-item" onClick={() => navigate('/main-store/user/manage-party', { state: elem })}><i
