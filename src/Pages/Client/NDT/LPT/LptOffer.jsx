    ...
    const commentsData = useMemo(() => {
        ...
        if (search) {
            computedComments = computedComments.filter(
                (mpt) =>
                    mpt.ndt_offer_no?.toLowerCase()?.includes(search?.toLowerCase())
            );
        }
        ...
        <div className={`main-wrapper ${isSidebarOpen ? 'slide-nav' : ''}`}>
            ...
            <div className="page-wrapper">
                <div className="content">
                    ...
                    {disable === false ? (
                        <NdtOfferTable
                            name={'Liquid Penetrant Testing Offer List'}
                            url={'/user/project-store/manage-lpt-offer'}
