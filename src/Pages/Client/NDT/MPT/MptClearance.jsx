...
import { getUserMptClearance } from '../../../../Store/Store/Ndt/MPT/MptClearance';
...
const MptClearance = () => {
    ...
    useEffect(() => {
        if (disable === true) {
            dispatch(getUserMptClearance());
            setDisable(false);
        }
    }, [dispatch, disable]);

    const entity = useSelector((state) => state.getUserMptClearance?.user?.data);
    ...
    const handleDownloadIns = (elem) => {
        ...
        PdfDownloadErp({ apiMethod: 'post', url: 'one-mpt-report-download', body: bodyFormData });
    }
                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                <ul className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active">Magnetic Particle Testing Clearance List</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                                        ...
                                                        <div className="doctor-search-blk">
                                                            ...
                                                            <div className="add-group">
                                                                {localStorage.getItem('ERP_ROLE') === QC && (
                                                                    <Link to="/user/project-store/manage-mpt-clearance"
