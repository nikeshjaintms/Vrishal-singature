...
const Fitup = () => {
    ...
    useEffect(() => {
        if (disable === true) {
            dispatch(getMultiFitup({limit, page: currentPage, search}))
            setDisable(false);
        }
        else{
            dispatch(getMultiFitup({limit, page: currentPage, search}))
...
const entity = useSelector((state) => state?.getMultiFitup?.user?.data?.data) || [];
const pagination = useSelector((state) => state?.getMultiFitup?.user?.data?.pagination) || {};
  ...
  if (pagination?.totalRecords) {
                                                        ...
                                                        <div className="doctor-search-blk">
                                                            ...
                                                            <div className="add-group">
                                                                {localStorage.getItem('ERP_ROLE') === `${PRODUCTION}` && (
                                                                    <Link to="/user/project-store/manage-fitup"
    ...
    setCurrentPage(1); // Reset to first page when limit changes
                                                                ...
                                                                <td className="text-end">
                                                                    <div className="dropdown dropdown-action">
                                                                        ...
                                                                        <div className="dropdown-menu dropdown-menu-end">
                                                                            <button type='button' className="dropdown-item" onClick={() => navigate('/user/project-store/manage-fitup', { state: elem })}>
                                        ...
                                        <div className="row align-center mt-3 mb-2">
                                           ...
                                           <div className="dataTables_info" id="DataTables_Table_0_info" role="status"
     aria-live="polite">
  Showing  {Math.min(currentPage * limit, totalItems)} of {totalItems} entries
</div>
