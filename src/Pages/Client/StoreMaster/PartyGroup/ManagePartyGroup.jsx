...
const ManagePartyGroup = () => {
  ...
  const handleSubmit = () => {
    if (validation()) {
      ...
      dispatch(addPartyGroup(formData)).then((res) => {
        // console.log(res, 'REs');
        if (res.payload.success === true) {
          navigate('/user/project-store/party-group-management');
          setPartyGroup('');
        }
        setDisable(false)
      }).catch((error) => {
            ...
            <div className="row">
              <div className="col-sm-12">
                <ul className="breadcrumb">
                  ...
                  <li className="breadcrumb-item"><Link to="/user/project-store/party-group-management">Party Group List</Link></li>
                  <li className="breadcrumb-item"><i className="feather-chevron-right"></i></li>
