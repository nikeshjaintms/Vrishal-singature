...
import { getAdminUnit } from '../../../../Store/Store/StoreMaster/Unit/AdminUnit';
...
const Unit = () => {
  ...
  const entity = useSelector((state) => state?.getAdminUnit?.user?.data);
  // console.log(entity, '@@')
  ...
  const handleDelete = (id, title) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        const myurl = `${V_URL}/user/delete-unit`;
                      ...
                      <div className="row align-items-center">
                          ...
                          <div className="doctor-table-blk">
                            ...
                            <div className="doctor-search-blk">
                              ...
                              <div className="add-group">
                                <PlanningAuth>
                                  <Link to="/user/project-store/manage-unit"
                        ...
                        <div className="pageDropDown col-auto text-end float-end ms-auto download-grp">
                          <div className="add-group" style={{ marginRight: "10px" }}>
                            <DownloadFormat url={`${V_URL}/user/download-unit-format`} fileName="Unit.xlsx" />
                            <UploadFile url={`${V_URL}/user/upload-unit`} />
                          </div>
                                ...
                                <td className="text-end">
                                  <div className="dropdown dropdown-action">
                                    ...
                                    <div className="dropdown-menu dropdown-menu-end">
                                      <button type='button' className="dropdown-item" onClick={() => navigate('/user/project-store/manage-unit', { state: elem })}><i
