...
const ViewMultiSurface = () => {
  ...
  const fetchPdf = async () => {
    try {
      ...
      toast.error('Failed to load Surface PDF');
    } finally {
      setLoadingPdf(false);
    }
  };
        ...
        <div className="content">
          ...
          <div className="card">
            <div className="card-body">
              <h4 className="mb-3">Surface Inspection Details</h4>
              <div className="row">
                ...
                <>
                  ...
                  <div className="mt-3">
                    <button
                      ...
                      onClick={() => submitSurfaceStatus('REVIEWED')}
                    >
                      REVIEWED
                    </button>
                    ...
                    <button
                      ...
                      onClick={() => submitSurfaceStatus('WITNESSED')}
                    >
                      WITNESSED
                    </button>
              ...
              {showRandomItems && randomItems.length > 0 && (
                <div className="mt-3">
                  ...
                  <button
                    ...
                    onClick={() =>
                      submitSurfaceStatus('RANDOM WITNESSED')
                    }
                  >
...
export default ViewMultiSurface;
