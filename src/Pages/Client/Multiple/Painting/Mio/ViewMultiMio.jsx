...
const ViewMultiMio = () => {
  ...
  const fetchPdf = async () => {
    try {
      ...
      toast.error("Failed to load MIO PDF");
    } finally {
      setLoadingPdf(false);
    }
  };
  ...
  const prepareRandomWitnessedItems = () => {
    const items =
      data?.items?.map((item) => ({
        ...
        grid_qty: item?.mio_used_grid_qty || item?.grid_qty || 0,
        average_dft: item?.average_dft_mio || "-",
        acc_rej: item?.is_accepted === 2 ? "ACC" : (item?.is_accepted === 3 ? "REJ" : "--"),
        selected: false,
        remark: item?.remarks || "",
      })) || [];
        ...
        <div className="content">
          ...
          <div className="page-header">
            <ul className="breadcrumb">
              ...
              <li className="breadcrumb-item">
                <Link to="/party/project-store/mio-offer-management">MIO Offer List</Link>
              </li>
              <li className="breadcrumb-item"><i className="feather-chevron-right"></i></li>
              <li className="breadcrumb-item active">View MIO Summary</li>
            </ul>
          </div>
          ...
          <div className="card">
            <div className="card-body">
              <h4 className="mb-3">MIO Inspection Details</h4>
              <div className="row">
                ...
                <>
                  ...
                  <div className="mt-3">
                    <button
                      ...
                      onClick={() => submitMioStatus("REVIEWED")}
                    >
                      REVIEWED
                    </button>
                    ...
                    <button
                      ...
                      onClick={() => submitMioStatus("WITNESSED")}
                    >
                      WITNESSED
                    </button>
              ...
              {showRandomItems && randomItems.length > 0 && (
                <div className="mt-3">
                  ...
                  <button
                    ...
                    onClick={() => submitMioStatus("RANDOM WITNESSED")}
                  >
