...
import { GetFinalCoatClearance } from '../../../../../Store/MutipleDrawing/MultiFinalCoat/GetFinalCoatClearance';
import { GetFinalCoatQcOffer } from '../../../../../Store/MutipleDrawing/MultiFinalCoat/GetFinalCoatQcOffer';
const MultiFinalCoatClearance = () => {
...
const debouncedSearch1 = useDebounce(search1, 500);
  useEffect(() => {
    if (disable === true) {
      dispatch(GetFinalCoatQcOffer({page:currentPage,limit, search:debouncedSearch}));
      setDisable(false);
  ...
  dispatch(GetFinalCoatQcOffer({page:currentPage,limit, search:debouncedSearch}));
    ...
    useEffect(() => {
    if ( disable1 === true) {
      dispatch(GetFinalCoatClearance({page:currentPage1,limit:limit1, search:debouncedSearch1}));
  ...
  }, [disable1, currentPage1,limit1, debouncedSearch1]);

  const entity = useSelector((state) => state.GetFinalCoatQcOffer?.user?.data?.data);
  const pagination = useSelector((state) => state.GetFinalCoatQcOffer?.user?.data?.pagination);
console.log("entity",entity);
const entity1 = useSelector((state) => state.GetFinalCoatClearance?.user?.data?.data);

const pagination1 = useSelector((state) => state.GetFinalCoatClearance?.user?.data?.pagination);
...
console.log("entity1",entity1);
  ...
  //   const filtered = filterData(entity, 1, search);
  ...
  //   let filtered = filterData(entity, null, search1);
        ...
        <div className="page-wrapper">
          <div className="content">
            <PageHeader breadcrumbs={[
              ...
              { name: "Final/Top Coating Clearance List", link: "/party/project-store/", active: false },
            ]} />
                        ...
                        <div className="row align-items-center">
                          <div className="col">
                            <div className="doctor-table-blk">
                              <h3>Final/Top Coat Offering List</h3>
                            ...
                            {commentsData?.map((elem, i) =>
                              <tr key={elem?._id}>
                                ...
                                {ERP_ROLE === QC && (
                                  <td>
                                    {elem?.status === 1 ? (
                                      <span style={{ cursor: 'pointer' }} onClick={() => navigate('/party/project-store/manage-final-coat-clearance', { state: elem })}>
                                        <BadgeCheck />
                                      </span>
                                    ) : <X />}
                                  </td>
                    ...
                    <div className="card-body">
                      <div className="page-table-header mb-2">
                        <div className="row align-items-center">
                          <div className="col">
                            <div className="doctor-table-blk">
                              <h3>Final/Top Coat Clearance List</h3>
                              <div className="doctor-search-blk">
                                <div className="top-nav-search table-search-blk">
                                  <form>
                                    {/* <Search
                                ...
                                <td className="text-end">
                                  <div className="dropdown dropdown-action">
                                    ...
                                    <div className="dropdown-menu dropdown-menu-end">
                                      <button type='button' className="dropdown-item" onClick={() => navigate('/party/project-store/view-final-coat-clearance', { state: elem })}>
...
export default MultiFinalCoatClearance