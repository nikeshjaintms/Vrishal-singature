...
const MultiLptClearance = () => {
  ...
  const { data, loading } = useSelector((state) => state.getClientLptClearance);
  ...
  useEffect(() => {
    dispatch(getClientLptClearance({ page, limit, search: debouncedSearch }));
                              ...
                              <div className="dropdown dropdown-action">
                                ...
                                <div className="dropdown-menu dropdown-menu-end">
                                  <button
                                    ...
                                    onClick={() =>
                                      navigate(
                                        "/party/project-store/view-lpt-clearance-summary",
                                        { state: r }
                                      )
                                    }
                                  >
