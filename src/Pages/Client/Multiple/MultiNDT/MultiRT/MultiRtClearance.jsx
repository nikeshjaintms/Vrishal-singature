...
//     useEffect(() => {
//         if (disable1) {
//             dispatch(getMultiRtClearance());
//             setDisable1(false);
//         }
//     }, [disable1]);

//     const entity = useSelector((state) => state.getMultiNdtOffer?.user?.data);
//     const entity2 = useSelector((state) => state.getMultiRtClearance?.user?.data);
...
//         PdfDownloadErp({ apiMethod: 'post', url: 'download-multi-rt-inspection', body: bodyFormData });
//     }
//     return (
//         <>
...
//                                                                             <button type='button' className="dropdown-item" onClick={() => navigate('/user/project-store/manage-rt-clearance', { state: elem })}><i
  ...
  const fetchData = async () => {
    try {
      ...
      const res = await axios.post(
        `${V_URL}/party/get-multi-rt-clearance`,
      ...
      console.error("RT Clearance error:", err);
      setRows([]);
      setTotalItems(0);
    } finally {
      setLoading(false);
                                        ...
                                        <td>
                                            {r.qc_verify === 1 ? (
                                              <BadgeCheck
                                                ...
                                                onClick={() =>
                                                navigate(
                                                    "/party/project-store/manage-rt-clearance",
                                                    { state: r }
                                                )
                                                }
                                              />
