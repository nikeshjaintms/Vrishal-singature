    ...
    const commentsData = useMemo(() => {
        ...
        if (search) {
            ...
            computedComments = computedComments?.filter(
                (ut) => {
                    const drawingNos = ut?.items?.map(e => e?.grid_item_id?.drawing_id?.drawing_no)?.filter(Boolean) || [];
                    const assemblyNos = ut?.items?.map(e => e?.grid_item_id?.drawing_id?.assembly_no)?.filter(Boolean) || [];
                    return (
                        ut.ndt_offer_no?.toString().toLowerCase()?.includes(search?.toLowerCase()) ||
                                                        ...
                                                        <td className="text-end">
                                                            <div className="dropdown dropdown-action">
                                                                ...
                                                                <div className="dropdown-menu dropdown-menu-end">
                                                                    <button type='button' className="dropdown-item" onClick={() => navigate('/party/project-store/manage-ut-offer', { state: elem })}><i
...
export default UTOfferCompletedList