...
const UTItemsList = ({ name, commentsData, url, limit, handleRefresh, currentPage,
                                    ...
                                    <div className="pageDropDown col-auto text-end float-end ms-auto download-grp">
                                        <div className="add-group mx-2">
                                            <button type='button' onClick={handleShowList}
                                                ...
                                                {showBtn ? 'Hide UT Completed List(Scroll Down)' : 'View UT Completed List'}
                                            </button>
                                        </div>
