...
// import { getMultiMptClearance } from '../../../../../Store/MutipleDrawing/MultiNDT/MptClearance/getMultiMptClearance';
...
//     useEffect(() => {
//         if (disable1) {
//             dispatch(getMultiMptClearance());
//             setDisable1(false);
//         }
//     }, [disable1]);

//     const entity = useSelector((state) => state.getMultiNdtOffer?.user?.data);
//     const entity2 = useSelector((state) => state.getMultiMptClearance?.user?.data);
...
//                 (mpt) =>
//                     mpt.name?.toLowerCase()?.includes(search?.toLowerCase())
//             );
//         }
...
//         PdfDownloadErp({ apiMethod: 'post', url: 'download-multi-mpt-inspection', body: bodyFormData });
//     }
//     return (
...
//                         { name: "Magnetic Particle Testing Clearance List", active: false },
//                     ]} />
...
//                                                                         <button type='button' className="dropdown-item" onClick={() => navigate('/user/project-store/manage-mpt-clearance', { state: elem })}><i
  ...
  const fetchData = async () => {
    try {
      ...
      const res = await axios.post(
        `${V_URL}/party/get-multi-mpt-clearance`,
      ...
      console.error("MPT Clearance Error:", err);
      setRows([]);
      setTotalItems(0);
    } finally {
      setLoading(false);
                                ...
                                <div className="dropdown dropdown-action">
                                    ...
                                    <div className="dropdown-menu dropdown-menu-end">
                                        <button
                                            ...
                                            onClick={() =>
                                            navigate(
                                                "/party/project-store/view-mpt-clearance-summary",
                                                { state: r }
                                            )
                                            }
                                        >
