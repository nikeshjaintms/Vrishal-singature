...
import { getClientReleaseNote } from '../../../../Store/Client/Structural/IRN/getClientReleaseNote';
...
const MultiReleaseNote = () => {
  ...
  const { data, loading } = useSelector((state) => state.getClientReleaseNote);
  ...
  useEffect(() => {
    dispatch(getClientReleaseNote({ page, limit, search: debouncedSearch }));
