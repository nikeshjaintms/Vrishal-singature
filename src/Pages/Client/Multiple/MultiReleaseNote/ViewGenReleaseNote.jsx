...
const ViewGenReleaseNote = () => {
  ...
  const submitReleaseNoteStatus = async (statusType) => {
    ...
    try {
      ...
      const res = await axios.post(
        `${V_URL}/party/release-note-review-update`,
        payload,
        {
          headers: {
            Authorization: 'Bearer ' + localStorage.getItem('PARTY_TOKEN'),
                ...
                <>
                  ...
                  <div className="mt-3">
                    <button
                      ...
                      onClick={() => submitReleaseNoteStatus('REVIEWED')}
                    >
                      REVIEWED
                    </button>
                    ...
                    <button
                      ...
                      onClick={() => submitReleaseNoteStatus('WITNESSED')}
                    >
                      WITNESSED
                    </button>
              ...
              {showRandomItems && randomItems.length > 0 && (
                <div className="mt-3">
                  ...
                  <button
                    ...
                    onClick={() => submitReleaseNoteStatus('RANDOM WITNESSED')}
                  >
...
//                                                 <h4>View Release Note For Site Dispatch Details</h4>
//                                             </div>
//                                         </div>
//                                         <div className='row'>
//                                             <div className="col-12 col-md-6 col-xl-6">
//                                                 <div className="input-block local-forms custom-select-wpr">
//                                                     <label>View Release Note For Site Dispatch List <span className="login-danger">*</span></label>
...
//                                                     <h3>View Release Note For Site Dispatch List</h3>
...
//                                                             </td>
//                                                             <td>
//                                                                 {elem?.surface_primer_report &&
//                                                                     elem.surface_primer_report.length > 0 ? (
//                                                                     elem.surface_primer_report
//                                                                         .filter((value, index, self) => self.indexOf(value) === index)
//                                                                         .map((e, index) => <div key={index}>{e}</div>)
//                                                                 ) : (
...
//                                                             </td>
//                                                             <td>
//                                                                 {elem?.mio_paint_report &&
//                                                                     elem.mio_paint_report.length > 0 ? (
//                                                                     elem.mio_paint_report
//                                                                         .filter((value, index, self) => self.indexOf(value) === index)
//                                                                         .map((e, index) => <div key={index}>{e}</div>)
//                                                                 ) : (
...
//                                                             </td>
//                                                             <td>
//                                                                 {elem?.final_coat_paint_report &&
//                                                                     elem.final_coat_paint_report.length > 0 ? (
//                                                                     elem.final_coat_paint_report
//                                                                         .filter((value, index, self) => self.indexOf(value) === index)
//                                                                         .map((e, index) => <div key={index}>{e}</div>)
//                                                                 ) : (
