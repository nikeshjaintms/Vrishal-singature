...
const NdtMaster = () => {
    ...
    const entity = useSelector((state) => state?.getUserNdtMaster?.user?.data);
    console.log("NDT Master List:", entity);
    ...
    console.log("Filtered NDT Data:", commentsData);
    ...
    const handleDelete = (id, title) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const myurl = `${V_URL}/user/delete-ndt`;
                                                    ...
                                                    <div className="doctor-table-blk">
                                                        ...
                                                        <div className="doctor-search-blk">
                                                            ...
                                                            <div className="add-group">
                                                                <WeldingAuth>
                                                                    <Link to="/user/project-store/manage-ndt-master"
                                                                    ...
                                                                    <div className="dropdown dropdown-action">
                                                                        ...
                                                                        <div className="dropdown-menu dropdown-menu-end">
                                                                            <button type='button' className="dropdown-item"
                                                                                onClick={() => navigate('/user/project-store/manage-ndt-master', { state: elem })}><i
