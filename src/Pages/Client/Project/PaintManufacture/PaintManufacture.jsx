...
import { getUserPaintManufacture } from '../../../../Store/Store/PaintManufacture/PaintManufacture';
import Loader from '../../Include/Loader';
import { Pagination, Search } from '../../Table';
import DropDown from '../../../../Components/DropDown';
import { PaintAuth } from '../../../../Routes/Users/Auth/AuthGuard';

const PaintManufacture = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            if (disable === true) {
                dispatch(getUserPaintManufacture({ status: '' }));
                setDisable(false);
            }
        }
        fetchData();
    ...
    const entity = useSelector((state) => state?.getUserPaintManufacture?.user?.data);
    ...
    const handleDelete = (id, title) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const myurl = `${V_URL}/user/delete-paint-manufacturer`;
                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                <ul className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active">Paint Manufacture List</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <div className="doctor-table-blk">
                                                        ...
                                                        <div className="doctor-search-blk">
                                                            ...
                                                            <div className="add-group">
                                                                <PaintAuth>
                                                                    <Link to="/user/project-store/manage-paint-manufacture"
                                                                    ...
                                                                    <div className="dropdown dropdown-action">
                                                                        ...
                                                                        <div className="dropdown-menu dropdown-menu-end">
                                                                            <button type='button' className="dropdown-item"
                                                                                onClick={() => navigate('/user/project-store/manage-paint-manufacture', { state: elem })}><i
...
export default PaintManufacture