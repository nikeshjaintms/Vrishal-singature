...
const PaintSystem = () => {
    ...
    const entity = useSelector((state) => state?.getUserPaintSystem?.user?.data);
    ...
    const handleDelete = (id, title) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const myurl = `${V_URL}/user/delete-painting-system`;
                                                    ...
                                                    <div className="doctor-table-blk">
                                                        ...
                                                        <div className="doctor-search-blk">
                                                            ...
                                                            <div className="add-group">
                                                                <PaintAuth>
                                                                    <Link to="/user/project-store/manage-painting-system"
                                                                    ...
                                                                    <div className="dropdown dropdown-action">
                                                                        ...
                                                                        <div className="dropdown-menu dropdown-menu-end">
                                                                            <button type="button" className="dropdown-item"
                                                                                onClick={() => navigate('/user/project-store/manage-painting-system', { state: elem })}>
