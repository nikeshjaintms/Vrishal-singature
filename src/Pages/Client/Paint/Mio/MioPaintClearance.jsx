...
const MioPaintClearance = () => {
    ...
    const entity = useSelector((state) => state.getUserMio?.user?.data);
    ...
    const commentsData = useMemo(() => {
        ...
        if (search) {
            computedComments = computedComments.filter(
                (mio) =>
                    mio?.voucher_no_two?.toLowerCase()?.includes(search?.toLowerCase())
            );
        }
    ...
    const handleDownloadIns = (elem) => {
        ...
        PdfDownloadErp({ apiMethod: 'post', url: 'mio-download', body: bodyFormData });
    }
                                                        ...
                                                        <div className="doctor-search-blk">
                                                            ...
                                                            <div className="add-group">
                                                                {localStorage.getItem('ERP_ROLE') === QC && (
                                                                    <Link to="/user/project-store/manage-mio-clearance"
                                                            ...
                                                            <td className="text-end">
                                                                <div className="dropdown dropdown-action">
                                                                    ...
                                                                    <div className="dropdown-menu dropdown-menu-end">
                                                                        <button type='button' className="dropdown-item" onClick={() => navigate('/user/project-store/manage-mio-clearance', { state: elem })}>
...
export default MioPaintClearance