...
const debouncedSearch = useDebounce(search, 500);
  useEffect(() => {
    const fetchData = async () => {
      // if (disable === true) {
        try {
          await dispatch(getAdminParty({ storeType: '', is_admin: false , currentPage, limit, search:debouncedSearch })).finally(()=>setDisable(false));
          // setDisable(false);
        } catch (error) {
          console.log(error, '!!')
          setDisable(false);
...
const paginationData = useSelector((state) => state?.getAdminParty?.user?.data?.pagination);
...
/>
                              ...
                              <div className="add-group">
                                <PlannerQcAuth>
                                  <Link to="/user/project-store/manage-party"
                                ...
                                <td className="text-end">
                                  <div className="dropdown dropdown-action">
                                    ...
                                    <div className="dropdown-menu dropdown-menu-end">
                                      <button type='button' className="dropdown-item" onClick={() => navigate('/user/project-store/manage-party', { state: elem })}><i
