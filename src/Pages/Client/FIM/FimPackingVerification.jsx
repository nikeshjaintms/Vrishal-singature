  ...
  const handleSubmitVerification = async () => {
    try {
      ...
      for (let item of items) {
        if(item.manufacture.trim() === "" || item.heat_no.trim() === "" || item.tc_no.trim() === ""){
          toast.error("Please fill Manufacture, Heat No and TC No for all items before submitting.");
          return;
        }
      }
      ...
      await axios.post(`${V_URL}/user/fim/verify-fim-packing`, bodyFormData, {
        headers: {
