...
import { getClientPipingMultiFinalCoat } from '../../../../../Store/Client/Piping/Painting/FinalCoat/getClientPipingMultiFinalCoat';
...
const MultiFinalCoatClearance = () => {
    ...
    const { data: reduxData, loading } = useSelector((state) => state.getClientPipingMultiFinalCoat);
    ...
    const fetchData = () => {
        dispatch(getClientPipingMultiFinalCoat({ page: currentPage, limit, search: debouncedSearch }));
    };
    ...
    const handleDownloadIns = async (elem) => {
        try {
            ...
            console.error('Final Coat PDF download error:', error?.response?.data || error);
                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                <ul className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active">Final / Top Coat Clearance List</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <tbody>
                                                        {rows?.map((elem, i) =>
                                                            <tr key={elem._id || i}>
                                                                ...
                                                                <td>{elem.qc_date ? moment(elem.qc_date).format('DD-MM-YYYY') : '-'}</td>
                                                                ...
                                                                <td className="text-end">
                                                                    <div className="dropdown dropdown-action">
                                                                        ...
                                                                        <div className="dropdown-menu dropdown-menu-end">
                                                                            <button type='button' className="dropdown-item" onClick={() => navigate('/party/piping-store/view-final-coat-clearance', { state: elem })}>
