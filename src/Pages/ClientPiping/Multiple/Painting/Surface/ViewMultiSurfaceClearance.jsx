...
const ViewMultiSurfaceClearance = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const data = location.state; // contains Surface Inspection report object

  console.log('Surface Inspection Data:', data);
  ...
  const fetchPdf = async () => {
    try {
      ...
      const res = await axios.post(
        `${V_URL}/party/download-piping-surface-client`,
        {
  ...
  /* ================= UPDATE STATUS ================= */
  const submitSurfaceStatus = async (statusType) => {
    if (!clientDate) {
    ...
    try {
      ...
      const res = await axios.post(`${V_URL}/party/update-piping-surface-status`, payload, {
        headers: {
          Authorization: 'Bearer ' + localStorage.getItem('PARTY_TOKEN'),
        },
      });
      ...
      if (res.data.success) {
        toast.success('Surface Clearance updated successfully');
        setShowRandomItems(false);
        fetchPdf();
        navigate("/party/piping-store/surface-clearance-management");
      } else {
        ...
        <div className="content">
          ...
          <div className="page-header">
            <ul className="breadcrumb">
              ...
              <li className="breadcrumb-item">
                <Link to="/party/piping-store/surface-clearance-management">Surface & Primer Clearance</Link>
              </li>
              <li className="breadcrumb-item"><i className="feather-chevron-right"></i></li>
              <li className="breadcrumb-item active">View Surface Clearance</li>
            </ul>
          </div>
          ...
          <div className="card">
            <div className="card-body">
              <h4 className="mb-3">Surface & Primer Details</h4>
              <div className="row">
            ...
            <div className="card-body">
              ...
              {showButtons && (
                <>
                  ...
                  <div className="mt-3">
                    <button className="btn btn-primary me-2" onClick={() => submitSurfaceStatus('REVIEWED')}>
                      REVIEWED
                    </button>

                    <button className="btn btn-warning me-2" onClick={() => submitSurfaceStatus('WITNESSED')}>
                      WITNESSED
                    </button>
              ...
              {showRandomItems && randomItems.length > 0 && (
                <div className="mt-3">
                  ...
                  <button className="btn btn-success mt-2" onClick={() => submitSurfaceStatus('RANDOM WITNESSED')}>
...
export default ViewMultiSurfaceClearance;
