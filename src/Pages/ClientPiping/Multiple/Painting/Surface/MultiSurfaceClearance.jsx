...
import { getClientPipingMultiSurface } from '../../../../../Store/Client/Piping/Painting/Surface/getClientPipingMultiSurface';
...
const MultiSurfaceClearance = () => {
    ...
    const { data: reduxData, loading } = useSelector((state) => state.getClientPipingMultiSurface);
    ...
    const fetchData = () => {
        dispatch(getClientPipingMultiSurface({ page: currentPage, limit, search: debouncedSearch }));
    };
    ...
    const handleDownloadIns = async (elem) => {
        try {
            ...
            console.error('Surface PDF download error:', error?.response?.data || error);
                                                                ...
                                                                <td className="text-end">
                                                                    <div className="dropdown dropdown-action">
                                                                        ...
                                                                        <div className="dropdown-menu dropdown-menu-end">
                                                                            <button type='button' className="dropdown-item" onClick={() => navigate('/party/piping-store/view-surface-clearance', { state: elem })}>
