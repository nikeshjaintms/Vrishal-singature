...
import { getClientPipingMultiMio } from '../../../../../Store/Client/Piping/Painting/MIO/getClientPipingMultiMio';
...
const MultiMioClearance = () => {
    ...
    const { data: reduxData, loading } = useSelector((state) => state.getClientPipingMultiMio);
    ...
    const fetchData = () => {
        dispatch(getClientPipingMultiMio({ page: currentPage, limit, search: debouncedSearch }));
    };
    ...
    const handleDownloadIns = async (elem) => {
        try {
            ...
            console.error('MIO PDF download error:', error?.response?.data || error);
                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                <ul className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active">MIO Clearance List</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                                                ...
                                                                <td className="text-end">
                                                                    <div className="dropdown dropdown-action">
                                                                        ...
                                                                        <div className="dropdown-menu dropdown-menu-end">
                                                                            <button type='button' className="dropdown-item" onClick={() => navigate('/party/piping-store/view-mio-clearance', { state: elem })}>
