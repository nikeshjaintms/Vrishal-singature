...
const MultiFtClearance = () => {
  ...
  const fetchData = async () => {
    ...
    setLoading(true);
    try {
      const res = await axios.post(`${V_URL}/party/get-piping-ft-client`, {
      ...
      console.log("FT Client Response data:", res?.data);
      ...
      if (res?.data) {
        if (Array.isArray(res.data.data)) {
          ...
          fetchedTotal = res.data.pagination?.totalItems || res.data.pagination?.total || res.data.totalItems || res.data.data.length;
        } else if (res.data.data && Array.isArray(res.data.data.data)) {
          fetchedRows = res.data.data.data;
          fetchedTotal = res.data.data.pagination?.totalItems || res.data.data.pagination?.total || res.data.data.totalItems || res.data.data.data.length;
        } else if (res.data.user && Array.isArray(res.data.user.data)) {
          fetchedRows = res.data.user.data;
          fetchedTotal = res.data.user.pagination?.totalItems || res.data.user.pagination?.total || res.data.user.totalItems || res.data.user.data.length;
        } else if (Array.isArray(res.data)) {
          fetchedRows = res.data;
          fetchedTotal = res.data.length;
        } else if (Array.isArray(res.data.result)) {
          fetchedRows = res.data.result;
          fetchedTotal = res.data.pagination?.totalItems || res.data.pagination?.total || res.data.result.length;
        }
      }
      ...
      console.error("Fetch FT clearance failed:", err);
      setRows([]);
      setTotalItems(0);
    } finally {
      setLoading(false);
