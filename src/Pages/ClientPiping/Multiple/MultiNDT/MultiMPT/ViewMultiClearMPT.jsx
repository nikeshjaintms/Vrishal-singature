...
const ViewMultiClearMPT = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const data = location.state; // contains MPT report object

  console.log('MPT Data:', data);
  ...
  const submitMPTStatus = async (statusType) => {
    ...
    try {
      ...
      const res = await axios.post(`${V_URL}/party/update-piping-mpt-status`, payload, {
        headers: {
          Authorization: 'Bearer ' + localStorage.getItem('PARTY_TOKEN'),
        },
      });
      ...
      if (res.data.success) {
        toast.success('MPT Clearance updated successfully');
        setShowRandomItems(false);
        fetchPdf();
        navigate("/party/piping-store/mpt-clearance-management");
      } else {
        ...
        <div className="content">
          ...
          <div className="page-header">
            <ul className="breadcrumb">
              ...
              <li className="breadcrumb-item">
                <Link to="/party/piping-store/mpt-clearance-management">MPT Acc / Rej</Link>
              </li>
              <li className="breadcrumb-item"><i className="feather-chevron-right"></i></li>
              <li className="breadcrumb-item active">View MPT Clearance</li>
            </ul>
          </div>
          ...
          <div className="card">
            <div className="card-body">
              <h4 className="mb-3">MPT Details</h4>
              <div className="row">
            ...
            <div className="card-body">
              ...
              {showButtons && (
                <>
                  ...
                  <div className="mt-3">
                    <button className="btn btn-primary me-2" onClick={() => submitMPTStatus('REVIEWED')}>
                      REVIEWED
                    </button>

                    <button className="btn btn-warning me-2" onClick={() => submitMPTStatus('WITNESSED')}>
                      WITNESSED
                    </button>
              ...
              {showRandomItems && randomItems.length > 0 && (
                <div className="mt-3">
                  ...
                  <button className="btn btn-success mt-2" onClick={() => submitMPTStatus('RANDOM WITNESSED')}>
...
export default ViewMultiClearMPT;
