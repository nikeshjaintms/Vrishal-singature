...
const ViewMultiClearHT = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const data = location.state; // contains HT report object
  ...
  const fetchPdf = async () => {
    try {
      ...
      console.error('HT PDF fetch error:', err);
  ...
  /* ================= UPDATE STATUS ================= */
  const submitHtStatus = async (statusType) => {
    if (!clientDate) {
    ...
    try {
      ...
      const res = await axios.post(`${V_URL}/party/update-piping-ht-status`, payload, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem('PARTY_TOKEN')}`,
        },
      });
      ...
      if (res.data.success) {
        toast.success('Hardness Testing Clearance updated successfully');
        setShowRandomItems(false);
        fetchPdf();
        navigate('/party/piping-store/ht-clearance-management');
      } else {
        ...
        <div className="content">
          ...
          <div className="page-header">
            <ul className="breadcrumb">
              ...
              <li className="breadcrumb-item">
                <Link to="/party/piping-store/ht-clearance-management">Hardness Testing Acc / Rej</Link>
              </li>
              <li className="breadcrumb-item">
                <i className="feather-chevron-right"></i>
              </li>
              <li className="breadcrumb-item active">View HT Clearance Summary</li>
            </ul>
          </div>
          ...
          <div className="card">
            <div className="card-body">
              <h4 className="mb-3">Hardness Testing Clearance Details</h4>
              <div className="row">
            ...
            <div className="card-body">
                ...
                <>
                  ...
                  <div className="mt-3">
                    <button
                      ...
                      onClick={() => submitHtStatus('REVIEWED')}
                    >
                      REVIEWED
                    </button>
                    ...
                    <button
                      ...
                      onClick={() => submitHtStatus('WITNESSED')}
                    >
                      WITNESSED
                    </button>
              ...
              {pdfUrl && (
                <div className="mt-4">
                  <iframe
                    src={pdfUrl}
                    title="Hardness Testing Inspection PDF"
                    width="100%"
                    height="700px"
              ...
              {showRandomItems && randomItems.length > 0 && (
                <div className="mt-3">
                  ...
                  <button className="btn btn-success mt-2" onClick={() => submitHtStatus('RANDOM WITNESSED')}>
...
export default ViewMultiClearHT;
