...
const ViewReleaseNote = () => {
  ...
  const data = location.state; // contains Release Note report object

  console.log('Release Note Data:', data);
  ...
  /* ================= UPDATE STATUS ================= */
  const submitReleaseNoteStatus = async (statusType) => {
    if (!clientDate) {
    ...
    try {
      ...
      const res = await axios.post(`${V_URL}/party/update-release-note-client-status`, payload, {
        headers: {
          Authorization: 'Bearer ' + localStorage.getItem('PARTY_TOKEN'),
        },
      });
      ...
      if (res.data.success) {
        toast.success('IRN / Release Note updated successfully');
        setShowRandomItems(false);
        fetchPdf();
        navigate("/party/piping-store/release-note-management");
      } else {
        ...
        <div className="content">
          ...
          <div className="page-header">
            <ul className="breadcrumb">
              ...
              <li className="breadcrumb-item">
                <Link to="/party/piping-store/release-note-management">IRN</Link>
              </li>
              <li className="breadcrumb-item"><i className="feather-chevron-right"></i></li>
              <li className="breadcrumb-item active">View IRN / Release Note</li>
            </ul>
          </div>
          ...
          <div className="card">
            <div className="card-body">
              <h4 className="mb-3">Release Note Details</h4>
              <div className="row">
                ...
                <div className="col-md-4">
                  ...
                  <input
                    ...
                    value={data.release_date ? moment(data.release_date).format('YYYY-MM-DD') : '-'}
                    readOnly
                  />
                </div>
              </div>
            ...
            <div className="card-body">
              ...
              {showButtons && (
                <>
                  ...
                  <div className="mt-3">
                    <button className="btn btn-primary me-2" onClick={() => submitReleaseNoteStatus('REVIEWED')}>
                      REVIEWED
                    </button>

                    <button className="btn btn-warning me-2" onClick={() => submitReleaseNoteStatus('WITNESSED')}>
                      WITNESSED
                    </button>
              ...
              {showRandomItems && randomItems.length > 0 && (
                <div className="mt-3">
                  ...
                  <button className="btn btn-success mt-2" onClick={() => submitReleaseNoteStatus('RANDOM WITNESSED')}>
