            ...
            <div className="row">
              <div className="col-sm-12">
                <ul className="breadcrumb">
                  ...
                  <li className="breadcrumb-item"><Link to="/piping/user/rt-offer-management">Radiography Offer List</Link></li>
                  <li className="breadcrumb-item"><i className="feather-chevron-right"></i></li>
                  ...
                  <div className="col-12">
                    <div className="doctor-submit text-end">
                      {localStorage.getItem('ERP_ROLE') === QC ? (
                        ...
                        <button className='btn btn-primary' type='button' onClick={() => navigate('/piping/user/rt-offer-management')}>
                          Back
                        </button>
                      )}
                    </div>
