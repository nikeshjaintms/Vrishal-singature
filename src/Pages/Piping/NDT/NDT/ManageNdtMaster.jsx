                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                <ul className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item"><Link to="/piping/user/ndt-management">NDT Master List</Link></li>
                                    <li className="breadcrumb-item"><i className="feather-chevron-right"></i></li>
                                            ...
                                            {localStorage.getItem('ERP_ROLE') === QC ? (
                                                <>
                                                    {!data?._id ? (
                                                        ...
                                                        <button type="button"
                                                            className="btn btn-primary submit-form me-2" onClick={() => navigate('/piping/user/ndt-management')}>Back</button>
                                                    )}
                                                </>
                                            ) : (
                                                <button type="button"
