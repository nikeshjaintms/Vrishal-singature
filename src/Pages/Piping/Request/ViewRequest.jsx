                                                ...
                                                <tbody>
                                                    ...
                                                    {data?.items?.map((elem, i) =>
                                                        <tr>
                                                            ...
                                                            <td>{elem?.itemName?.item_description}</td>

                                                            <td>{elem?.itemName?.size1?.name}</td>
                                                            <td>{elem?.itemName?.thickness1?.name}</td>
                                                            <td>{elem?.itemName?.size2?.name || '-'}</td>
                                                            <td>{elem?.itemName?.thickness2?.name || '-'}</td>
                                                            <td>{elem?.itemName?.material_grade}</td>
                                                            <td>{elem?.itemName?.uom?.name}</td>
                                                            <td>{elem?.quantity}</td>
                                                            <td>{elem?.balance_qty}</td>                                                     
                                                           {/* <td>{elem?.orderPlacement?.manufacture?.join(", ") || "-"}</td> */}
                                                                <td>
