                                                        ...
                                                        <tr key={elem?._id}>
                                                            ...
                                                            <td>
                                                                <button type='button' className='btn btn-primary'
                                                                    onClick={() => navigate('/piping/user/item-issue-management', { state: elem })}>
                                                                    Issue
                                                                </button>
                                                            </td>
                                                            <td className="text-end">
                                                                <div className="dropdown dropdown-action">
                                                                    ...
                                                                    <div className="dropdown-menu dropdown-menu-end">
                                                                        <button type='button' className="dropdown-item" onClick={() => navigate('/piping/user/view-approved-item', { state: elem })}>
