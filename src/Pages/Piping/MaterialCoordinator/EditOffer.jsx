...
import { getUOM } from "../../../Store/Piping/UOM/UOM";
const EditOffer = () => {
  ...
  const unitData = useSelector((state) => state.getUOM?.user?.data);
  ...
  const getRequestEdit = (requestId) => {
    const myurl = `${V_URL}/user/get-request-piping-edit`;
  ...
  const handleSubmit = () => {
    ...
    if (isValid) {
      ...
      axios
        .put(
          `${V_URL}/user/update-purchase-offer-piping`,
          {
            offerId: data?._id,
            updateData: {
        ...
        .then((response) => {
          if (response.data.success) {
            ...
            navigate("/piping/user/offer-item-management", {
              state: {
                ...data, 
                ...data.requestId, 
                    ...
                    <div className="col-12 col-md-4 col-xl-4">
                      <div className="input-block local-forms">
                        ...
                        <input
                          ...
                          className="form-control"
                          value={offerDate}
                          min={moment(data?.admin_approval_time).format(
                            "YYYY-MM-DD"
                          )}
                      ...
                      <div className="row">
                        <div className="col-12 col-md-4 col-xl-4">
                          <div className="input-block local-forms">
                            ...
                            <input
                              className="form-control"
                              defaultValue={elem?.itemName?.item_name}
                              readOnly
                              disabled
                            />
                          </div>
                        ...
                        <div className="col-12 col-md-4 col-xl-4">
                          <div className="input-block local-forms">
                            ...
                            <input
                              className="form-control"
                              defaultValue={elem?.itemName?.material_grade}
                              readOnly
                              disabled
                            />
                          </div>
                        ...
                        <div className="col-12 col-md-4 col-xl-4">
                          <div className="input-block local-forms">
                            ...
                            <input
                              className="form-control"
                              defaultValue={elem?.itemName?.uom?.name}
                              readOnly
                              disabled
                            />
                          </div>
