...
useEffect(() => {
  dispatch(
    ...
    const entity = useSelector((state) => state.getMultipleIssueRequestPiping?.issues?.data);
    const pagination = useSelector((state) => state.getMultipleIssueRequestPiping?.issues?.pagination);
...
console.log("commentsData",commentsData);
    ...
    const handleDownload = (option) => {
        ...
        if (ispdf) {
            PdfDownloadErp({ apiMethod: 'post', url: 'download-multi-issue-request-piping', body: bodyFormData });
    ...
    // }
const handleRefresh = () => {
  dispatch(getMultipleIssueRequestPiping({ limit, page: currentPage , project }));
};
                                                        ...
                                                        <div className="doctor-search-blk">
                                                            ...
                                                            <div className="add-group">
                                                                {localStorage.getItem('ERP_ROLE') === `${PRODUCTION}` &&
                                                                    <Link to="/piping/user/manage-issue-request"
                                                        ...
                                                        <tr key={i}>
                                                            ...
                                                            <td className="text-end">
                                                                <div className="dropdown dropdown-action">
                                                                    ...
                                                                    <div className="dropdown-menu dropdown-menu-end">
                                                                        <button type='button' className="dropdown-item" onClick={() => navigate('/piping/user/manage-issue-request', { state: elem } )}><i
