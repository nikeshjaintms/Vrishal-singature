...
useEffect(() => {
  ...
  const entity = useSelector((state) => state?.getStockIssueAcceptancePiping?.user?.data);
  const pagination = useSelector((state) => state?.getStockIssueAcceptancePiping?.user?.data?.total);

const commentsData = entity?.items || [];



    const entity2 = useSelector((state) => state.getStockIssueRequestPiping?.issues?.data);
     const pagination2 = useSelector((state) => state.getStockIssueRequestPiping?.issues?.pagination);
...
// }, [search1, entity2]);
    ...
    const handleDownload = (options) => {
        ...
        bodyFormData.append('stock_issue_accept_no', elem?.stock_issue_accept_no);
        bodyFormData.append('print_date', true);

        if (ispdf) {
            // PdfDownloadErp({ apiMethod: 'post', url: 'one-issue-acceptance-download', body: bodyFormData });
            PdfDownloadErp({ apiMethod: 'post', url: 'download-multi-stock-issue-acceptance-piping', body: bodyFormData });
        } else {
            PdfDownloadErp({ apiMethod: 'post', url: 'download-multi-stock-issue-acceptance-piping', body: bodyFormData });
            // PdfDownloadErp({ apiMethod: 'post', url: 'one-issue-acceptance-download', body: bodyFormData });
        }
                                            ...
                                            <div className="row align-items-center">
                                                <div className="col">
                                                    <div className="doctor-table-blk">
                                                        <h3>Stock Issue Request List</h3>
                                                    ...
                                                    {commentsData2?.map((elem, i) =>
                                                        <tr key={elem?._id}>
                                                            ...
                                                            {ERP_ROLE === `${M_CON}` &&
                                                                <td>
                                                                    {elem?.status === 1 ? (
                                                                        <span style={{ cursor: 'pointer' }} onClick={() => navigate('/piping/user/create-stock-wise-issue-acceptance', { state: elem })}>
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="page-table-header mb-2">
                                            <div className="row align-items-center">
                                                <div className="col">
                                                    <div className="doctor-table-blk">
                                                        <h3>Stock Issue Acceptance List</h3>
                                                        <div className="doctor-search-blk">
                                                            <div className="top-nav-search table-search-blk">
                                                                <form>
                                                                    <Search
                                                ...
                                                <tbody>
                                                    {commentsData?.map((elem, i) =>
                                                        <tr key={elem?._id}>
                                                            ...
                                                            <td>{elem?.stock_issue_accept_no}</td>
                                                            <td>
                                                                {elem?.items
                                                            ...
                                                            <td className="text-end">
                                                                <div className="dropdown dropdown-action">
                                                                    ...
                                                                    <div className="dropdown-menu dropdown-menu-end">
                                                                        <button type='button' className="dropdown-item" onClick={() => navigate('/piping/user/manage-stock-wise-issue-acceptance', { state: {elem, isView: elem?.status === 4} })}><i
