...
useEffect(() => {
  dispatch(
    ...
    const entity = useSelector((state) => state.getMultipleIssueReturnPiping?.issues?.data);
    const pagination = useSelector((state) => state.getMultipleIssueReturnPiping?.issues?.pagination);
...
//       (request) =>
//         request.issue_return_no?.toString().toLowerCase().includes(search.toLowerCase()) ||
...
console.log("commentsData",commentsData);
    ...
    const handleDownload = (option) => {
        ...
        bodyFormData.append('issue_return_no', elem?.issue_return_no);
        bodyFormData.append('print_date', true);

        if (ispdf) {
            PdfDownloadErp({ apiMethod: 'post', url: 'download-multi-issue-return-piping', body: bodyFormData });
    ...
    // }
const handleRefresh = () => {
  dispatch(getMultipleIssueReturnPiping({ limit, page: currentPage , project }));
};
                                            ...
                                            <div className="row align-items-center">
                                                <div className="col">
                                                    <div className="doctor-table-blk">
                                                        <h3>Material Issue Return List</h3>
                                                        <div className="doctor-search-blk">
                                                            ...
                                                            <div className="add-group">
                                                                {localStorage.getItem('ERP_ROLE') === `${PRODUCTION}` &&
                                                                    <Link to="/piping/user/manage-issue-return"
                                        ...
                                        <div className="table-responsive">
                                            <table className="table border-0 custom-table comman-table  mb-0">
                                                <thead>
                                                    <tr>
                                                        <th>Sr.</th>
                                                        <th>Material Issue Return No.</th>   
                                                        <th>Item</th>                                                                                                     
                                                        <th>Return. By</th>
                                                        <th>Return Date</th>                                                
                                                        ...
                                                        <tr key={i}>
                                                            ...
                                                            <td className="text-end">
                                                                <div className="dropdown dropdown-action">
                                                                    ...
                                                                    <div className="dropdown-menu dropdown-menu-end">
                                                                        <button type='button' className="dropdown-item" onClick={() => navigate('/piping/user/manage-issue-return', { state: elem } )}><i
...
export default IssueReturnNote