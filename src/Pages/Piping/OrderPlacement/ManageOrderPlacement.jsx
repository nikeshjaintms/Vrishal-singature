...
import OrderPlacementItemModal from '../../../Components/OrderPlacement/OrderPlacementItemModal';
import { useDispatch, useSelector } from 'react-redux';
import { getItem } from '../../../Store/Store/Item/Item';
import { getAreasAction } from '../../../Store/PoTeam/Area/AreaSlice';
import OrderPlacementSectionTable from '../../../Components/OrderPlacement/OrderPlacementSectionTable';
import OrderPlacementNote from '../../../Components/OrderPlacement/OrderPlacementTermCondition';
import { getMaterialMtoById } from '../../../Store/PoTeam/MaterialMTO/MaterialMto';

const ManageOrderPlacement = () => {
  ...
  const handleSave = () => {
    if (!finalId && !data?._id) {
      toast.error("Please save Order Placement details first!");
      return;
    }
            ...
            <div className="row">
              <div className="col-sm-12">
                <ul className="breadcrumb">
                  ...
                  <li className="breadcrumb-item">
                    <Link to="/piping/user/order-placement">Order Placement List</Link>
                  </li>
                  <li className="breadcrumb-item">
                    <i className="feather-chevron-right"></i>
                  </li>
                  <li className="breadcrumb-item active">
                    {data?._id ? "Edit" : "Add"} Order Placement
                  </li>
                </ul>
              </div>
            </div>
                  ...
                  <form>
                    <div className="col-12">
                      <div className="form-heading">
                        <h4>{data?._id ? "Edit" : "Add"} Order Placement Details</h4>
                      </div>
                    </div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-12 col-md-6 col-xl-6">
                        <div className="input-block local-forms">
                          ...
                          <input className="form-control" type="date" onChange={handleChange} name="date" value={mto.date} />
                        </div>
                      </div>
                      <div className="col-12 col-md-6 col-xl-6">
                        <div className="input-block local-forms">
                          <label>Email</label>
                          <input className="form-control" type="email"  name="date" />
                        </div>
                      </div> 
                      <div className="col-12 col-md-6 col-xl-6">
                        <div className="input-block local-forms">
...
export default ManageOrderPlacement;
