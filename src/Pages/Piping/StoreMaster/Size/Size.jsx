...
const Size = () => {
  ...
  const entity = useSelector((state) => state?.getAdminSize?.user?.data);
  
  console.log("entity size", entity);
  // console.log(entity, '@@')
  ...
  const handleDelete = (id, title) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        const myurl = `${V_URL}/user/delete-size`;
            ...
            <div className="row">
              <div className="col-sm-12">
                <ul className="breadcrumb">
                  ...
                  <li className="breadcrumb-item active">Size List</li>
                </ul>
              </div>
            </div>
          </div>
                      ...
                      <div className="row align-items-center">
                          ...
                          <div className="doctor-table-blk">
                            ...
                            <div className="doctor-search-blk">
                              ...
                              <div className="add-group">
                                <PlanningAuth>
                                  <Link to="/piping/user/manage-size"
                        ...
                        <div className="pageDropDown col-auto text-end float-end ms-auto download-grp">
                          {/* <div className="add-group" style={{ marginRight: "10px" }}>
                            <DownloadFormat url={`${V_URL}/user/download-size-format`} fileName="Size.xlsx" />
                            <UploadFile url={`${V_URL}/user/upload-size`} />
                          </div> */}
                                ...
                                <td className="text-end">
                                  <div className="dropdown dropdown-action">
                                    ...
                                    <div className="dropdown-menu dropdown-menu-end">
                                      <button type='button' className="dropdown-item" onClick={() => navigate('/piping/user/manage-size', { state: elem })}><i
