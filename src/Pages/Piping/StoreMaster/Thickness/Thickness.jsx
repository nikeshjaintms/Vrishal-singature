...
const Thickness = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      if (disable === true) {
        try {
          await dispatch(getAdminThickness())
          setDisable(false);
        } catch (error) {
          console.log(error, '!!')
          setDisable(false);
  ...
  const entity = useSelector((state) => state?.getAdminThickness?.user?.data);
  // console.log(entity, '@@')
  ...
  const commentsData = useMemo(() => {
    ...
    if (search) {
      computedComments = computedComments.filter(
        (thickness) =>
          thickness.name?.toLowerCase()?.includes(search?.toLowerCase())
      );
    }
  ...
  const handleDelete = (id, title) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        const myurl = `${V_URL}/user/delete-thickness`;
            ...
            <div className="row">
              <div className="col-sm-12">
                <ul className="breadcrumb">
                  ...
                  <li className="breadcrumb-item active">Thickness List</li>
                </ul>
              </div>
            </div>
          </div>
                      ...
                      <div className="row align-items-center">
                          ...
                          <div className="doctor-table-blk">
                            ...
                            <div className="doctor-search-blk">
                              ...
                              <div className="add-group">
                                <PlanningAuth>
                                  <Link to="/piping/user/manage-thickness"
                        ...
                        <div className="pageDropDown col-auto text-end float-end ms-auto download-grp">
                          {/* <div className="add-group" style={{ marginRight: "10px" }}>
                            <DownloadFormat url={`${V_URL}/user/download-thickness-format`} fileName="Thickness.xlsx" />
                            <UploadFile url={`${V_URL}/user/upload-thickness`} />
                          </div> */}
                                ...
                                <td className="text-end">
                                  <div className="dropdown dropdown-action">
                                    ...
                                    <div className="dropdown-menu dropdown-menu-end">
                                      <button type='button' className="dropdown-item" onClick={() => navigate('/piping/user/manage-thickness', { state: elem })}><i
