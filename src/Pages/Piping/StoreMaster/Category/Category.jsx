...
const Category = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      if (disable === true) {
        try {
          await dispatch(getAdminItemCategory())
          setDisable(false);
        } catch (error) {
          console.log(error, '!!')
          setDisable(false);
  ...
  const entity = useSelector((state) => state?.getAdminItemCategory?.user?.data);
  ...
  const handleDelete = (id, title) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        const myurl = `${V_URL}/user/delete-piping-item-Category`;
            ...
            <div className="row">
              <div className="col-sm-12">
                <ul className="breadcrumb">
                  ...
                  <li className="breadcrumb-item active">Item Category List</li>
                </ul>
              </div>
            </div>
          </div>
                      ...
                      <div className="row align-items-center">
                            ...
                            <div className="doctor-search-blk">
                              ...
                              <div className="add-group">
                                <PlanningMaterialAuth>
                                  <Link to="/piping/user/manage-category"
                        ...
                        <div className="pageDropDown col-auto text-end float-end ms-auto download-grp">
                          <div className="add-group" style={{ marginRight: "10px" }}>
                            <DownloadFormat url={`${V_URL}/user/download-itemCategory-format`} fileName="ItemCategory.xlsx" />
                               <PlanningMaterialAuth>
                            <UploadFile url={`${V_URL}/user/upload-itemCategory`} />
                            </PlanningMaterialAuth>
                          </div>
                                ...
                                <td className="text-end">
                                  <div className="dropdown dropdown-action">
                                    ...
                                    <div className="dropdown-menu dropdown-menu-end">
                                      <button type='button' className="dropdown-item" onClick={() => navigate('/piping/user/manage-category', { state: elem })}><i
