...
const Unit = () => {
  ...
  const entity = useSelector((state) => state?.getAdminUOM?.user?.data);
  // console.log(entity, '@@')
  ...
  const handleDelete = (id, title) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        const myurl = `${V_URL}/user/delete-uom`;
                          ...
                          <div className="doctor-table-blk">
                            ...
                            <div className="doctor-search-blk">
                              ...
                              <div className="add-group">
                                <PlanningAuth>
                                  <Link to="/piping/user/manage-unit"
                                ...
                                <td className="text-end">
                                  <div className="dropdown dropdown-action">
                                    ...
                                    <div className="dropdown-menu dropdown-menu-end">
                                      <button type='button' className="dropdown-item" onClick={() => navigate('/piping/user/manage-unit', { state: elem })}><i
