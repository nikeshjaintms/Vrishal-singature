...
import ProcurementRequestItemModal from '../../../Components/ProcurementRequest/ProcurementRequestItemModal';
import { useDispatch, useSelector } from 'react-redux';
import { getItem } from '../../../Store/Store/Item/Item';
import { getAreasAction } from '../../../Store/PoTeam/Area/AreaSlice';
import ProcurementRequestSectionTable from '../../../Components/ProcurementRequest/ProcurementRequestSectionTable';
import ProcurementRequestNote from '../../../Components/ProcurementRequest/ProcurementRequestNote';
import { getMaterialMtoById } from '../../../Store/PoTeam/MaterialMTO/MaterialMto';

const ManageProcurementRequest = () => {
...
const handleSave = () => {
  if (!finalId && !data?._id) {
    toast.error("Please save Procurement Request details first!");
    return;
  }
    ...
    <div className={`main-wrapper ${isSidebarOpen ? 'slide-nav' : ''}`}>
      ...
      <div className="page-wrapper">
        <div className="content">
            ...
            <div className="row">
              <div className="col-sm-12">
                <ul className="breadcrumb">
                  ...
                  <li className="breadcrumb-item">
                    <Link to="/piping/user/procurement-request">Procurement Request List</Link>
                  </li>
                  <li className="breadcrumb-item">
                    <i className="feather-chevron-right"></i>
                  </li>
                  <li className="breadcrumb-item active">
                    {data?._id ? "Edit" : "Add"} Procurement Request
                  </li>
                </ul>
              </div>
            </div>
                  ...
                  <form>
                    <div className="col-12">
                      <div className="form-heading">
                        <h4>{data?._id ? "Edit" : "Add"} Procurement Request Details</h4>
                      </div>
                    </div>
          ...
          <div className="row">
            <div className="col-sm-12">
              <ProcurementRequestSectionTable
      ...
      {/* Direct Modal */}
      <ProcurementRequestItemModal
        show={show}               // 👈 Must use this state
...
export default ManageProcurementRequest;
