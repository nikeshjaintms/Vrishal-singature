...
const commentsData = useMemo(() => {
    ...
    if (status) {
        return entity.filter(fit => fit.status === parseInt(status));
    }
...
useEffect(() => {
    ...
    const handleDownloadOffer = (elem) => {
        ...
        PdfDownloadErp({ apiMethod: 'post', url: 'download-final-dimension-pdf-piping', body: bodyFormData });
    }
                                                        ...
                                                        <div className="doctor-search-blk">
                                                            ...
                                                            <div className="add-group">
                                                                {localStorage.getItem('ERP_ROLE') === PRODUCTION && (
                                                                    <Link to="/piping/user/manage-final-dimension-offer"
