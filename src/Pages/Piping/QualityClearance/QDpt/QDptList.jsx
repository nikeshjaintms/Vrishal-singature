...
const QDptList = () => {
 ...
 const debouncedSearch1 = useDebounce(search1, 600);
    ...
    //         dispatch(getMultiDptPiping({ page: currentPage, limit }));
    //         setDisable(false);
    //     }
    //     else{
    //          dispatch(getMultiDptPiping({ page: currentPage, limit }));
...
const totalCount = useSelector((state) => state?.getMultiDptPiping?.user?.pagination?.totalRecords); // <== NEW

const pendingData = useSelector(
  (state) => state.getMultiDptPiping?.pendingList?.data
);
const pendingDataTotalCount = useSelector(
  (state) => state.getMultiDptPiping?.pendingList?.pagination?.totalRecords
);
console.log("pendingDataTotalCount",pendingDataTotalCount);

const completedData = useSelector(
  (state) => state.getMultiDptPiping?.completedList?.data
);

const completedDataTotalCount = useSelector(
  (state) => state.getMultiDptPiping?.completedList?.pagination?.totalRecords
);
                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                <ul className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active">DPT Clearance List</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                                       ...
                                                       <td>
                                                         {elem?.status === 1 ? (
                                                           <span
                                                             ...
                                                             onClick={() =>
                                                               navigate('/piping/user/quality-clearance-dpt-management', { state: elem })
                                                             }
                                                           >
                                                             <BadgeCheck />
                                                           </span>
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="page-table-header mb-2">
                                            <div className="row align-items-center">
                                                <div className="col">
                                                    <div className="doctor-table-blk">
                                                        <h3>DPT Clearance Completed List</h3>
                                                        <div className="doctor-search-blk">
                                                            <div className="top-nav-search table-search-blk">
