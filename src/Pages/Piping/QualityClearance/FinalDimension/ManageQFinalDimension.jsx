            ...
            <div className="page-wrapper">
                <div className="content">
                                    ...
                                    <form>
                                        <div className="col-12">
                                            <div className="form-heading">
                                                <h4>{data?._id ? 'Edit' : 'Add'} Final Dimension Details</h4>
                                            </div>
                                        </div>
                                        <div className='row'>
                                            <div className="col-12 col-md-6 col-xl-6">
                                                <div className="input-block local-forms custom-select-wpr">
                                                    <label> FD Offer List <span className="login-danger">*</span></label>
                    ...
                    <SubmitButton disable={disable} handleSubmit={handleSubmit}
                        link={'/piping/user/final-dimension-clearance-management'} buttonName={'Generate FD Acceptance'} />
...
export default ManageQFinalDimension