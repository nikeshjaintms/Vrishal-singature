    ...
    const handleSubmit = () => {
        ...
        axios({
            ...
            if (response.data.success === true) {
                ...
                navigate('/piping/user/dpt-offer-management');
            }
            setDisable(false);
        }).catch((error) => {
            ...
            <div className="page-wrapper">
                <div className="content">
                    ...
                    <PageHeader breadcrumbs={[
                        ...
                        { name: "Liquid Penetrant Testing Offer List", link: "/piping/user/dpt-offer-management", active: false },
                                    ...
                                    <form>
                                        <div className="col-12">
                                            <div className="form-heading">
                                                <h4>Manage Liquid Penetrant Testing Offer Details</h4>
                                            </div>
                                        </div>
                                        <div className='row'>
                    ...
                    <SubmitButton disable={disable} handleSubmit={handleSubmit} link={'/piping/user/dpt-offer-management'} buttonName={'Generate DPT Offer'} finalReq={data?.status !== 1 ? data?.items : []} />
...
export default ManageMultiDptOffer