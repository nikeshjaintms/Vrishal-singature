...
const ManageMultiNDT = () => {
  ...
  const weldVisualData = useSelector((state) => state?.getMultiWeldVisual?.user?.data);
      ...
      if (response?.data?.success === true) {
        ...
        dispatch(updateNDTOfferTable({ updatedData })).then((response) => {
          if (response.payload.success === true) {
            navigate('/piping/user/ndt-management');
          }
        })
      } else {
        ...
        <div className="content">
          <PageHeader
            breadcrumbs={[
              ...
              { name: "NDT Master List", link: "/piping/user/ndt-management", active: false, },
          ...
          <SubmitButton finalReq={data?.items} link='/piping/user/ndt-management'
