            ...
            <div className="page-wrapper">
                <div className="content">
                    <PageHeader breadcrumbs={[
                        ...
                        { name: "Release Note For Site Dispatch List", link: "/piping/user/release-note-management", active: false },
                                                ...
                                                {commentsData?.length > 0 ? (
                                                    commentsData?.map((elem, i) => (
                                                        <tr key={i}>
                                                            ...
                                                            <td>{elem?.rev}</td>
                                                            <td>{elem?.piping_class?.name}</td>
                                                            <td>{elem?.piping_material_spec?.name}</td>
                                                            <td>{elem?.item_name || elem.spool_no}</td>
                                                            <td>{elem?.size1?.name} {""}{elem.size2?.name}</td>
                                                            <td>
                                ...
                                <div className="card-body">
                                    <div className="col-12 text-end">
                                        <div className="doctor-submit text-end">
                                            <button type="button"
                                                className="btn btn-primary submit-form me-2" onClick={() => navigate('/piping/user/release-note-management')}>Back</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
