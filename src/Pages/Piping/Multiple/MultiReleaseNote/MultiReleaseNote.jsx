...
import { GetMultiReleaseNotePiping } from '../../../../Store/Piping/MultiReleaseNote/GetMultiReleaseNote';
import { GetMultiGenReleaseNotePiping } from '../../../../Store/Piping/MultiReleaseNote/GetMultiGeneratedReleaseNote';
...
const MultiReleaseNote = () => {
    ...
    const fatchData = () => {
        dispatch(GetMultiReleaseNotePiping({ page: currentPage, limit, search: debouncedSearch }))
        dispatch(GetMultiGenReleaseNotePiping({ page: currentPage1, limit: limit1, search: debouncedSearch1 }))
        setDisable(false);
    }
    ...
    useEffect(() => {
        ...
        dispatch(GetMultiReleaseNotePiping({ page: currentPage, limit, search: debouncedSearch })).finally(
            () => setDisable(false)
        );
    ...
    useEffect(() => {
        dispatch(GetMultiGenReleaseNotePiping({ page: currentPage1, limit: limit1, search: debouncedSearch1 })).finally(
            () => setDisable1(false)
        );
    }, [debouncedSearch1, currentPage1, limit1, dispatch]);


    const entity = useSelector(state => state.GetMultiReleaseNotePiping?.data?.data?.data);
    const pagination = useSelector(state => state.GetMultiReleaseNotePiping?.data?.data?.pagination);
    const genratedEntity = useSelector(state => state.GetMultiGenReleaseNotePiping?.user?.data?.data);
    const pagination1 = useSelector(state => state.GetMultiGenReleaseNotePiping?.user?.data?.pagination);
    ...
    const handleDownload = () => {
        ...
        const myurl = `${V_URL}/user/piping/generate-multi-release-note`;
        axios({
            method: "post",
            url: myurl,
            data: payload,
    ...
    const handleDownloadIns = (elem) => {
        ...
        PdfDownloadErp({ apiMethod: 'post', url: 'piping/download-multi-release-generate', body: bodyFormData });
    }
                                                            ...
                                                            <div className="dropdown dropdown-action">
                                                                ...
                                                                <div className="dropdown-menu dropdown-menu-end">
                                                                    <button
                                                                        ...
                                                                        onClick={() =>
                                                                            navigate("/piping/user/view-release-note", {
                                                                                state: elem,
                                                                            })
                                                                        }
                                                                    >
                                                                    ...
                                                                    <div className="dropdown dropdown-action">
                                                                        ...
                                                                        <div className="dropdown-menu dropdown-menu-end">
                                                                            <button
                                                                                ...
                                                                                className="dropdown-item"
                                                                                onClick={() =>
                                                                                    navigate("/piping/user/view-Genrelease-note", {
                                                                                        state: elem,
                                                                                    })
                                                                                }
                                                                            >
