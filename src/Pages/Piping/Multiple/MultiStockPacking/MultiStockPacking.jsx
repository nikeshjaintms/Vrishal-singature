...
import { getMultiStockPackingPipingList } from '../../../../Store/Piping/MultiStockPacking/GetMultiStockPackingPipingList';
...
const MultiPacking = () => {
    ...
    useEffect(() => {
        dispatch(
            getMultiStockPackingPipingList({
                page: currentPage,
                limit,
                search,
            })
    ...
    const entity = useSelector((state) => state?.getMultiStockPackingPipingList?.user?.data?.data);
    const pagination = useSelector((state) => state?.getMultiStockPackingPipingList?.user?.data?.pagination);
    ...
    const handleDownloadIns = (elem) => {
        ...
        PdfDownloadErp({ apiMethod: 'post', url: 'piping/download-multi-stock-packing', body: bodyFormData });
    }
                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                <ul className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active">Stock Packing List</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <div className="doctor-table-blk">
                                                        ...
                                                        <div className="doctor-search-blk">
                                                            ...
                                                            <div className="add-group">
                                                                {
                                                                    localStorage.getItem("ERP_ROLE") === PLAN ? <Link to="/piping/user/manage-stock-packing"
                                                            ...
                                                            <td className="text-end">
                                                                <div className="dropdown dropdown-action">
                                                                    ...
                                                                    <div className="dropdown-menu dropdown-menu-end">
                                                                        <button type='button' className="dropdown-item" onClick={() => navigate('/piping/user/view-stock-packing', { state: { elem: elem } })}><i className="fa-solid fa-eye m-r-5"></i>
                                                                            View</button>
