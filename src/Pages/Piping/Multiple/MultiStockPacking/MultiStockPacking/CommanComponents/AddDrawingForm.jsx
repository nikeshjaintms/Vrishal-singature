      ...
      <Modal.Body>
        <div className="row g-3">
          ...
          <div className="col-md-6">
            ...
            />
            <div className="error">{error.drawing_no}</div>
          </div>
          {/* Item */}
          <div className="col-md-6">
            <label>Item</label>
          ...
          <div className="col-md-6">
            ...
            <div className="error">{error.piping_class}</div>
          </div>
          ...
          <div className="col-md-6">
            ...
            <div className="error">{error.service}</div>
          </div>
          ...
          <div className="col-md-6">
            ...
            <input
              className="form-control"
              value={form.piping_material_specification_name || ""}
              disabled
            />
          </div>
