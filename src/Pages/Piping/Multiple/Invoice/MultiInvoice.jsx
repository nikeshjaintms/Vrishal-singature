...
import { getMultiPipeInvoice } from '../../../../Store/Piping/Invoice/getMultiPipeInvoice';
...
const MultiInvoice = () => {
    ...
    useEffect(() => {
        if (disable) {
            dispatch(getMultiPipeInvoice());
            setDisable(false);
        }
    }, [disable]);

    const entity = useSelector((state) => state?.getMultiPipeInvoice?.user?.data);
    ...
    const handleDownloadReport = (elem, status) => {
        ...
        PdfDownloadErp({ apiMethod: 'post', url: 'piping/download-pdf-invoice', body: bodyFormData });
    }
                                                    ...
                                                    <div className="doctor-table-blk">
                                                        ...
                                                        <div className="doctor-search-blk">
                                                            ...
                                                            <div className="add-group">
                                                                {localStorage.getItem("ERP_ROLE") === PLAN ? <Link to="/piping/user/manage-invoice"
                                                            ...
                                                            <td className="text-end">
                                                                <div className="dropdown dropdown-action">
                                                                    ...
                                                                    <div className="dropdown-menu dropdown-menu-end">
                                                                        {/* <button type='button' className="dropdown-item" onClick={() => navigate('/piping/user/manage-invoice', { state: elem })}><i className="fa-solid fa-eye m-r-5"></i>
                                                                            View</button> */}
                                                                        {moment().diff(moment(elem?.createdAt), 'days') < 2 && (
                                                                            <button type='button' className="dropdown-item" onClick={() => navigate('/piping/user/manage-invoice', { state: elem })}><i className="fa-solid fa-pen-to-square m-r-5"></i>
                                                                                Edit</button>
                                                                        )}
