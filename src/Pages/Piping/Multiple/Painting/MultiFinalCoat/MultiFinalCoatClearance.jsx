...
import { GetPipingFinalCoatIns } from '../../../../../Store/Piping/MultiFinalCoat/GetFinalCoatOffer';
...
const MultiFinalCoatClearance = () => {
  ...
  useEffect(() => {
    if (disable === true || disable1 === true) {
      dispatch(GetPipingFinalCoatIns());
      setDisable(false);
      setDisable1(false);
    }
  }, [disable, disable1]);

  const entity = useSelector((state) => state.GetPipingFinalCoatIns?.user?.data);
  ...
  const commentsData1 = useMemo(() => {
    ...
    return filtered?.slice((currentPage1 - 1) * limit1, currentPage1 * limit1);
  ...
  const handleDownloadIns = (elem) => {
    ...
    PdfDownloadErp({ apiMethod: 'post', url: 'piping-download-multi-final_coat', body: bodyFormData });
  }
        ...
        <div className="page-wrapper">
          <div className="content">
            <PageHeader breadcrumbs={[
              ...
              { name: "Final/Top Coating Clearance List", link: "/piping/user/", active: false },
            ]} />
                            ...
                            {commentsData?.map((elem, i) =>
                              <tr key={i}>
                                ...
                                {ERP_ROLE === QC && (
                                  <td>
                                    {elem?.status === 1 ? (
                                      <span style={{ cursor: 'pointer' }} onClick={() => navigate('/piping/user/manage-final-coat-clearance', { state: elem })}>
                                        <BadgeCheck />
                                      </span>
                                    ) : <X />}
                                  </td>
                                ...
                                <td className="text-end">
                                  <div className="dropdown dropdown-action">
                                    ...
                                    <div className="dropdown-menu dropdown-menu-end">
                                      {/* <button type='button' className="dropdown-item" onClick={() => navigate('/piping/user/view-final-coat-clearance', { state: elem })}>
