...
const MultiSurfaceClearance = () => {
    ...
    useEffect(() => {
        if (disable === true || disable1 === true) {
            dispatch(getPipingMultiSurfaceOffer());
            setDisable(false);
            setDisable1(false);
        }
    }, [disable, disable1]);
                                                        ...
                                                        <tr key={i}>
                                                            ...
                                                            <td>
                                                                {elem?.items && elem.items.length > 0 ? (
                                                                    [...new Set(elem.items.map((e) => e?.drawing_no).filter(Boolean))].map((drawing, index) => (
                                                            ...
                                                            <td>
                                                                {elem?.items && elem.items.length > 0 ? (
                                                                    [...new Set(elem.items.map((e) => e?.rev).filter(Boolean))].map((rev, index) => (
                                                            ...
                                                            {localStorage.getItem('ERP_ROLE') === QC && (
                                                                <td>
                                                                    {elem?.status === 1 ? (
                                                                        <span style={{ cursor: 'pointer' }} onClick={() => navigate('/piping/user/manage-surface-clearance', { state: elem })}>
                                                                            <BadgeCheck />
                                                                        </span>
                                                                    ) : <X />}
                                                                </td>
