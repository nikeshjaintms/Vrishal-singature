    ...
    const handleSubmit = () => {
        ...
        axios({
            ...
            if (response.data.success === true) {
                ...
                navigate('/piping/user/ft-offer-management');
            }
            setDisable(false);
        }).catch((error) => {
            ...
            <div className="page-wrapper">
                <div className="content">
                    ...
                    <PageHeader breadcrumbs={[
                        ...
                        { name: "Ferrite Offer List", link: "/piping/user/ft-offer-management", active: false },
                        { name: `${data?._id ? 'Edit' : 'Add'} Ferrite Offer`, active: true }
                    ]} />
                                    ...
                                    <form>
                                        <div className="col-12">
                                            <div className="form-heading">
                                                <h4>Manage Ferrite Test Offer Details</h4>
                                            </div>
                                        </div>
                                        <div className='row'>
                                            <div className="col-12 col-md-4 col-xl-4">
                                                <div className="input-block local-forms">
                                                    ...
                                                    {/* <input className='form-control' value={data?.ndt_master_id?.report_no} readOnly /> */}
                    ...
                    <SubmitButton disable={disable} handleSubmit={handleSubmit} link={'/piping/user/ft-offer-management'} buttonName={'Generate FT Offer'} finalReq={data?.status !== 1 ? data?.items : []} />
...
export default ManageMultiFTOffer