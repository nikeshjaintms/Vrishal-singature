...
const LptItemsList = ({ name, commentsData, url, limit, handleRefresh, currentPage,
                  ...
                  <div className="pageDropDown col-auto text-end float-end ms-auto download-grp">
                    <div className="add-group mx-2">
                      <button type='button' onClick={handleShowList}
                        ...
                        {showBtn ? 'Hide LPT Completed List(Scroll Down)' : 'View LPT Completed List'}
                      </button>
                    </div>
