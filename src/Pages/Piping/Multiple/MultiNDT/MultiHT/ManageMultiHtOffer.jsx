            ...
            <div className="page-wrapper">
                <div className="content">
                    ...
                    <PageHeader breadcrumbs={[
                        ...
                        { name: "Liquid Penetrant Testing Offer List", link: "/piping/user/lpt-offer-management", active: false },
                    ...
                    <SubmitButton disable={disable} handleSubmit={handleSubmit} link={'/piping/user/lpt-offer-management'} buttonName={'Generate LPT Offer'} finalReq={data?.status !== 1 ? data?.items : []} />
...
export default ManageMultiLptOffer