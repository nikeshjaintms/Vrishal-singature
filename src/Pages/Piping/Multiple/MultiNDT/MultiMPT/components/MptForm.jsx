...
const MptForm = ({ data, mptForm, error, handleChange2, mpt, handleChange, procedureOptions }) => {
    return (
        <>
            <div className='row'>
                                ...
                                <div className='row'>
                                    ...
                                    <div className="col-12 col-md-4 col-xl-4">
                                        <div className="input-block local-forms custom-select-wpr">
                                            ...
                                            <input className='form-control' value={data?.status === 0 ? data?.offer_no : data?.offer_no} readOnly />
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="card-body">
                            <form>
                                ...
                                <div className='row'>
                                    ...
                                    <div className='col-12 col-md-4 col-xl-4'>
                                        <div className='input-block local-forms'>
                                            <label>Magnetization</label>
                                            <input type='text' className='form-control' value={mptForm.magnetization} name='magnetization'
                                                onChange={handleChange2} // readOnly={data?.status !== 2} 
                                            />
                                        </div>
                                        <div className='error'>{error?.magnetization_err}</div>
                                    </div>
                                    <div className='col-12 col-md-4 col-xl-4'>
                                        <div className='input-block local-forms'>
