      ...
      <div className="page-wrapper">
        <div className="content">
          ...
          <PageHeader breadcrumbs={[
            ...
            { name: "Magnetic Particle Testing Offer List", link: "/piping/user/mpt-offer-management", active: false },
          ...
          <SubmitButton disable={disable} handleSubmit={handleSubmit} link={'/piping/user/mpt-offer-management'} buttonName={'Generate MPT Offer'} finalReq={data?.status !== 1 ? data?.items : []} />
...
export default ManageMultiMptOffer