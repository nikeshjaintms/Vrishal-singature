        ...
        <>
            ...
            <div className='row'>
                <div className='col-12 col-md-4 col-xl-4'>
                    <div className='input-block local-forms'>
                        <label>Source</label>
                        <input type='text' className='form-control' value={rtForm.source} name='source' readOnly={data?.status !== 0}
                ...
                <div className='col-12 col-md-4 col-xl-4'>
                    <div className='input-block local-forms'>
                        <label>Screen</label>
                        <input type='text' className='form-control' value={rtForm.screen} name='screen'
                            onChange={handleChange2} />
                    </div>
                    <div className='error'>{error?.screen_err}</div>
                </div>
                <div className='col-12 col-md-4 col-xl-4'>
                    <div className='input-block local-forms'>
