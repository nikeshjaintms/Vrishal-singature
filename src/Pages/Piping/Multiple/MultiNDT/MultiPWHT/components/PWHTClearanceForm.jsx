...
const [pwhtType, setPwhtType] = useState(null);

const pwhtTypeOptions = [
    { label: "Local PWHT", value: "LOCAL" },
    { label: "Overall PWHT", value: "OVERALL" },
    { label: "Furnace PWHT", value: "FURNACE" },
];
...
export default PWHTClearanceForm