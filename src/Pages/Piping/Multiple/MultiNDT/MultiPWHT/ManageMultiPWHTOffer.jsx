        ...
        <div className={`main-wrapper ${isSidebarOpen ? "slide-nav" : ""}`}>
            ...
            <div className="page-wrapper">
                <div className="content">
                    ...
                    <SubmitButton disable={disable} handleSubmit={handleSubmit} link={'/piping/user/rt-offer-management'} buttonName={'Generate RT Offer'} finalReq={data?.status !== 1 ? data?.items : []} />
...
export default ManageMultiPWHTOffer