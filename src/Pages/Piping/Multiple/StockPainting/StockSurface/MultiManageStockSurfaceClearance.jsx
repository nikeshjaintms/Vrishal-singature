...
import SurafceClearanceTable from './Components/StockSurafceClearanceTable';
...
const MultiManageSurfaceClearance = () => {
    ...
    const handleSubmit = (submitData = {}) => {
        if (validateSurfaceData.current && validateSurfaceData.current()) {
            ...
            const myurl = `${V_URL}/user/piping-verify-multi-stock-surface`;
            ...
            axios({
                ...
                .then((response) => {
                    if (response.data?.success === true) {
                        ...
                        navigate('/piping/user/stock-surface-clearance-management');
                    } else {
            ...
            <div className="page-wrapper">
                <div className="content">
                    <PageHeader breadcrumbs={[
                        ...
                        { name: "Surface & Primer Clearance List", link: "/piping/user/stock-surface-clearance-management", active: false },
                    ...
                    <SubmitButton disable={disable} handleSubmit={handleSubmit} showSurfaceClearance={true}
                        link={'/piping/user/stock-surface-clearance-management'} buttonName={'Generate Surface & Primer Clearance'} />
