...
const MultiViewSurfaceClearanc = () => {
    ...
    const multiDis = useSelector((state) =>
    Array.isArray(state.getPipingStockDispatchNotes?.user?.data)
        ? state.getPipingStockDispatchNotes.user.data
        : []
);
    ...
    useEffect(() => {
        ...
        dispatch(getPipingStockDispatchNotes({ project:localStorage.getItem('U_PROJECT_ID'), page:currentPage, limit, search }));
        // dispatch(getDrawing());
    ...
    useEffect(() => {
        if (paintNo) {
            ...
            const paintData = paints?.find(
    item => item.paint_system_no?._id === paintNo
);
    console.log("paintData===========>",paintData)

            setPaintData({
                paint_system_no: paintData?.paint_system_no?.paint_system_no || '',
                ...
                <div className="page-wrapper">
                    <div className="content">
                        <PageHeader breadcrumbs={[
                            ...
                            { name: "Surface & Primer Offer List", link: "/piping/user/stock-surface-clearance-management", active: false },
                            { name: `${data?._id ? 'Edit' : 'Add'} Stock Surface & Primer Offer`, active: true }
                        ]} />
                        ...
                        <SubmitButton finalReq={data?.items} link='/piping/user/stock-surface-clearance-management'
