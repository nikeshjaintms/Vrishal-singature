...
const MultiSurface = () => {
  ...
  const totalCount = useSelector((state) => state.getPipingMultiStockSurfaceOffer?.user?.data?.pagination?.total || 0);
  const loading = useSelector((state) => state.getPipingMultiStockSurfaceOffer?.loading);

  useEffect(() => {
    dispatch(getPipingMultiStockSurfaceOffer({ page: currentPage, limit, search:debouncedSearch }));
            ...
            <div className="row">
              <div className="col-sm-12">
                <ul className="breadcrumb">
                  ...
                  <li className="breadcrumb-item active">Stock Surface & Primer List</li>
                </ul>
              </div>
            </div>
          </div>
                      ...
                      <div className="row align-items-center">
                        <div className="col">
                          <div className="doctor-table-blk">
                            <h3>Stock Surface & Primer Offer List</h3>
                            <div className="doctor-search-blk">
                              ...
                              <div className="add-group">
                                {localStorage.getItem('ERP_ROLE') === PRODUCTION && (
                                  <Link to="/piping/user/manage-stock-surface-primer"
                              ...
                              <td className="text-end">
                                <div className="dropdown dropdown-action">
                                  ...
                                  <div className="dropdown-menu dropdown-menu-end">
                                    <button type='button' className="dropdown-item" onClick={() => navigate('/piping/user/view-stock-surface-clearance', { state: elem })}>
