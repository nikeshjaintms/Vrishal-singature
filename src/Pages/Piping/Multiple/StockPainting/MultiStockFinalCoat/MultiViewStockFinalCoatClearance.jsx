...
const MultiViewFinalCoatClearance = () => {
    ...
    const multiDis = useSelector((state) => state.getDispatchNotes?.user?.data);
    ...
    useEffect(() => {
        if (data?.paint_system_id) {
            ...
            setOfferObj({
                time: data?.time || '',
                paint_batch_base: data?.paint_batch_base || '',
                shelf_life: data?.shelf_life || '',
                paint_batch_hardner: data?.paint_batch_hardner || '',
                ...
                <div className="page-wrapper">
                    <div className="content">
                        <PageHeader breadcrumbs={[
                            ...
                            { name: "Final/Top Coat List", link: "/piping/user/final-coat-clearance-management", active: false },
                                    ...
                                    <div className="col-sm-12">
                                        <div className="card">
                                            <div className="card-body">
                                                <h4>{data?._id ? 'Edit' : 'Add'} Final/Top Coat</h4>
                        ...
                        <SubmitButton finalReq={data?.items} link='/piping/user/final-coat-clearance-management'
...
export default MultiViewFinalCoatClearance