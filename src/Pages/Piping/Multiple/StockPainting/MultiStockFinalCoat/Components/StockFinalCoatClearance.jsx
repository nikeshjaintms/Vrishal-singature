...
const FinalCoatClearance = ({ commentsData, limit, setLimit, setSearch, setCurrentPage, currentPage, totalItems, tableData, setTableData }) => {
    ...
    const handleEditClick = (index, row) => {
        ...
        setEditFormData({
            average_dft_final_coat: row.average_dft_final_coat || '',
            remark: row.remark || '',
        });
    };
                                ...
                                <div className='row align-items-center'>
                                    <div className="col">
                                        <div className="doctor-table-blk">
                                            <h3>Final / Top Coating Offer Clearance List</h3>
                                ...
                                <table className='table border-0 custom-table comman-table mb-0'>
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Piping Class</th>
                                            <th>Shade No.</th>
                                            <th>Average DFT Final / Top Coat</th>
                                            <th>Remarks</th>
                                            <th>Acc/Rej</th>
                                            <th>Status</th>
                                            <th>Action</th>
                                            ...
                                            commentsData.map((elem, i) => (
                                                <tr key={i}>
                                                    ...
                                                    {editRowIndex === i ? (
                                                        <>
                                                            <td>
                                                                <textarea
                                                                    ...
                                                                    name="average_dft_final_coat"
                                                                    onChange={handleEditFormChange}
                                                                    value={editFormData.average_dft_final_coat}
                                                                    rows={1}
                                                                />
                                                            </td>
                                                            <td>
                                                        ...
                                                        <>
                                                            <td onClick={() => handleEditClick(i, elem)}>{elem?.average_dft_final_coat || <span>-</span>}</td>
                                                        ...
                                                        <td className=''>
                                                            <div className='d-flex gap-2'>
                                                                <span
                                                                    ...
                                                                    onClick={() => handleAcceptRejectClick(i, true, elem?.drawing_no || elem?.item_name || 'Item')}
                                                                >
                                                                    <Check />
                                                                </span>
                                                                <span
                                                                    ...
                                                                    style={{ cursor: "pointer" }}
                                                                    onClick={() => handleAcceptRejectClick(i, false, elem?.drawing_no || elem?.item_name || 'Item')}
                                                                >
                                                                    <X />
                                                                </span>
                                                            </div>
...
export default FinalCoatClearance