...
const MultiFinalCoat = () => {
  ...
  useEffect(() => {
    // if (disable === true) {
      dispatch(getPipingStockFinalCoatIns({page:currentPage,limit,search}));
      setDisable(false);
    // }
  }, [disable, currentPage, limit, search]);

  const entity = useSelector((state) => state.getPipingStockFinalCoatIns?.user?.data);
  const pagination = useSelector((state) => state.getPipingStockFinalCoatIns?.user?.data?.pagination);

  console.log("entity", entity);

  const commentsData = useMemo(() => {
    let computedComments = Array.isArray(entity) ? entity : (Array.isArray(entity?.data) ? entity.data : []);
    // if (search) {
        ...
        <div className="page-wrapper">
          <div className="content">
            <PageHeader breadcrumbs={[
              ...
              { name: "Final / Top Coating Offer List", link: "/piping/user/stock-final-coat-management", active: true },
            ]} />
                              ...
                              <div className="doctor-search-blk">
                                ...
                                <div className="add-group">
                                  {localStorage.getItem('ERP_ROLE') === PRODUCTION && (
                                    <Link to="/piping/user/manage-stock-final-coat"
                                ...
                                <td className="text-end">
                                  <div className="dropdown dropdown-action">
                                    ...
                                    <div className="dropdown-menu dropdown-menu-end">
                                      <button type='button' className="dropdown-item" onClick={() => navigate('/piping/user/manage-stock-final-coat', { state: elem })}>
