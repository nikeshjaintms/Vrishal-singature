                ...
                <div className="page-wrapper">
                    <div className="content">
                        <PageHeader breadcrumbs={[
                            ...
                            { name: "MIO Offer List", link: "/piping/user/mio-clearance-management", active: false },
                        ...
                        <SubmitButton finalReq={data?.items} link='/piping/user/mio-clearance-management'
...
export default MultiViewMioClearance