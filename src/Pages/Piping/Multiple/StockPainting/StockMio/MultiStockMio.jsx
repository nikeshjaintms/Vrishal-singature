...
import { getMultiStockMioIns } from '../../../../../Store/Piping/MultiStockMIO/GetMultiStockMioIns';
...
const MultiMio = () => {
  ...
  const debouncedSearch = useDebounce(search, 500);
    ...
    useEffect(() => {
            ...
            dispatch(getPipingMultiStockMioViewPage({ paint_system_id: "", page: currentPage, limit, search:debouncedSearch }));

            setDisable(false);
      
    }, [disable, dispatch, currentPage, limit, debouncedSearch]);



    const entity = useSelector((state) => state.getPipingMultiStockMioViewPage?.user?.data?.data);
    const pagination = useSelector((state) => state.getPipingMultiStockMioViewPage?.user?.data?.pagination);
                                                            ...
                                                            <div className="doctor-search-blk">
                                                                ...
                                                                <div className="add-group">
                                                                    {localStorage.getItem('ERP_ROLE') === PRODUCTION && (
                                                                        <Link to="/piping/user/manage-stock-mio-offer"
