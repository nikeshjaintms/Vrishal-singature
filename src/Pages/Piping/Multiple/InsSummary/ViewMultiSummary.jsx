      ...
      <div className="page-wrapper">
        <div className="content">
          <PageHeader breadcrumbs={[
            ...
            { name: "Inspection Summary Records List", link: "/piping/user/inspection-summary-management", active: false },
                ...
                <div className="card-body">
                  <div className="col-12 text-end">
                    <div className="doctor-submit text-end">
                      <button type="button"
                        className="btn btn-primary submit-form me-2" onClick={() => navigate('/piping/user/inspection-summary-management')}>Back</button>
                    </div>
                  </div>
                </div>
              </div>
