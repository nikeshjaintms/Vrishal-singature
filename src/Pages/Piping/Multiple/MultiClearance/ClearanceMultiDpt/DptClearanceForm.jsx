                                ...
                                <div className='row'>
                                    <div className='col-12 col-md-4 col-xl-4'>
                                        <div className='input-block local-forms'>
                                            ...
                                            <input type='text' className='form-control' value={dptForm.surface_condition} name='surface_condition' onChange={handleChange2} />
                                    ...
                                    <div className='col-12 col-md-4 col-xl-4'>
                                        <div className='input-block local-forms'>
                                            ...
                                            <input type='text' className='form-control' value={dptForm.surface_temperature} name='surface_temperature' onChange={handleChange2} />
                                    ...
                                    <div className='col-12 col-md-4 col-xl-4'>
                                        <div className='input-block local-forms'>
                                            ...
                                            <input type='text' className='form-control' value={dptForm.examination_stage} name='examination_stage' onChange={handleChange2} />
                                    ...
                                    <div className='col-12 col-md-4 col-xl-4'>
                                        <div className='input-block local-forms'>
                                            ...
                                            <input type='text' className='form-control' value={dptForm.technique} name='technique' onChange={handleChange2} />
                                    ...
                                    <div className='col-12 col-md-4 col-xl-4'>
                                        <div className='input-block local-forms'>
                                            ...
                                            <input type='text' className='form-control' value={dptForm.lighting_equipment} name='lighting_equipment' onChange={handleChange2} />
                                    ...
                                    <div className='col-12 col-md-4 col-xl-4'>
                                        <div className='input-block local-forms'>
                                            ...
                                            <input type='text' className='form-control' value={dptForm.lighting_intensity} name='lighting_intensity' onChange={handleChange2} />
                                    ...
                                    <div className='col-12 col-md-4 col-xl-4'>
                                        <div className='input-block local-forms'>
                                            ...
                                            <input type='text' className='form-control' value={dptForm.extent_examination} name='extent_examination' onChange={handleChange2} />
...
export default DptClearanceForm