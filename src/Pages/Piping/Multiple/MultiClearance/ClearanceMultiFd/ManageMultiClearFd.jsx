...
console.log("data",data);
        ...
        if (search) {
            computedComments = computedComments?.filter(
                (i) =>
                    ...
                    i?.material_specification?.toLowerCase()?.includes(search?.toLowerCase()) ||
                    i?.spool_no?.toLowerCase()?.includes(search?.toLowerCase())
    ...
    console.log("commentsData qc page",commentsData);
    ...
    const handleSubmit = () => {
        ...
        setDisable(true);
        const myurl = `${V_URL}/user/verify-fd-inspection-piping`;
        ...
        axios({
            ...
            if (response.data?.success === true) {
                ...
                navigate('/piping/user/final-dimension-clearance-management');
                ...
                <div className="page-wrapper">
                    <div className="content">
                        <PageHeader breadcrumbs={[
                            ...
                            { name: "Final Dimension Clearance List", link: "/piping/user/final-dimension-clearance-management", active: false },
                                                                 ...
                                                                 {editRowIndex === i ? (
                                                                    <td>
                                                                        <textarea
                                                                            ...
                                                                            value={editFormData.required_dimension}
                                                                            rows={1}
                                                                        />
                                                                    </td>
                                                                ) : (
                                                                    ...
                                                                    {editRowIndex === i ? (
                                                                        <div className='d-flex gap-2'>
                                                                            <span className={`present-table attent-status ${acceptRejectStatus[i] === true ? 'selected' : ''}`}
                                                                                ...
                                                                                onClick={() => handleAcceptRejectClick(i, true, elem?.drawing_no)}>
                                                                                <Check />
                                                                            </span>
                                                                            <span className={`absent-table attent-status ${acceptRejectStatus[i] === false ? 'selected' : ''}`}
                                                                                style={{ cursor: 'pointer' }}
                                                                                onClick={() => handleAcceptRejectClick(i, false, elem?.drawing_no)}>
                                                                                <X />
                                                                            </span>
                                                                        </div>
                                                                    ) : (
                        ...
                        <SubmitButton disable={disable} handleSubmit={handleSubmit} 
                            link={'/piping/user/final-dimension-clearance-management'} buttonName={'Generate Final Dimension Acceptance'} />
