...
useEffect(() => {
  ...
  if (data?.stock_issue_req_id) {
    setAcc({ 
      reqId: typeof data.stock_issue_req_id === "object"
        ? data.stock_issue_req_id._id
        : data.stock_issue_req_id
    });

    // Map issue request details properly
    setIssAcc({
      stock_issue_req_no: data.stock_issue_req_id.stock_issue_req_no || "",
      requested_by: data.stock_issue_req_id.requested_by || {},
...
issued_total_requested_qty: Number(
  ...
  body.append("stock_issue_req_id", data?.stock_issue_req_id?._id);
            ...
            <div className="page-wrapper">
                <div className="content">
                    <PageHeader
                        ...
                        { name: "Issue Acceptance List", link: "/piping/user/stock-wise-issue-management", active: false },
                                                ...
                                                <div className="input-block local-forms custom-select-wpr">
                                                    <label>Issue Request No. <span className="login-danger">*</span></label>
                                                     <input
                                                            ...
                                                            value={data?.stock_issue_req_id.stock_issue_req_no || ""}
                                                            disabled
                                                        />
                                                ...
                                                <tbody>
                                                    {commentsData?.map((elem, i) => (
                                                        <tr key={elem?._id}>
                                                            ...
                                                            <td>{elem?.issued_stock_qty ?? "-"}</td>                                                     
                                                            <td>{elem?.issued_requested_qty ?? "-"}</td>
                                    ...
                                    <div className="col-12 text-end">
                                        <div className="doctor-submit text-end">
                                            <button
                                                ...
                                                onClick={() => navigate('/piping/user/stock-wise-issue-management')}
                                            >
                                                Back
                                            </button>
                                        </div>
