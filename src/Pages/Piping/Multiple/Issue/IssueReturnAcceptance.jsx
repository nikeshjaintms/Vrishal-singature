...
if (!hasValidEntry) {
  ...
  null,
        ...
        axios.post(`${V_URL}/user/manage-material-issue-return-acceptance-piping`, bodyFormData, {
            headers: { 
                ...
                <div className="content">
                    <PageHeader
                        breadcrumbs={[
                            ...
                            { name: "Issue Return Acceptance List", link: "/piping/user/issue-return-management", active: false },
