...
const FitUpDrawingTable = ({
 ...
 console.log("data fit up drawing table",data);
...
<td className='text-end'>
    {!data?._id ? (
        <button
            className="btn btn-primary"
            type="button"
            onClick={() => handleAddToIssueArr(elem.drawing_id,elem.spool_no_id)}
        >
            Add
        </button>
    ) : (<>-</>)}
...
export default FitUpDrawingTable
