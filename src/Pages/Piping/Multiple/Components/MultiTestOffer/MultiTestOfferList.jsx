...
const MultiTestOfferList = ({ name, commentsData, url, limit, handleRefresh, currentPage, setCurrentPage, setSearch, setlimit, totalItems, handleDownloadOffer }) => {
                                    ...
                                    <tbody>
                                        {commentsData?.map((elem, i) =>
                                            <tr key={elem?._id}>
                                                ...
                                                {/* <td>{elem?.ndt_master_id?.report_no}</td> */}
...
export default MultiTestOfferList;