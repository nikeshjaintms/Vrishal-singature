            ...
            <div className="page-wrapper">
                <div className="content">
                    <PageHeader breadcrumbs={[
                        ...
                        { name: "Dispatch Note- PAINTING", link: "/piping/user/dispatch-note-management", active: false },
                                ...
                                <div className="card-body">
                                    <div className="col-12 text-end">
                                        <div className="doctor-submit text-end">
                                            <button type="button"
                                                className="btn btn-primary submit-form me-2" onClick={() => navigate('/piping/user/dispatch-note-management')}>Back</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
