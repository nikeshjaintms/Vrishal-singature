                                        ...
                                        <div className='row'>
                                            <div className="doctor-submit text-end">
                                                <button type="button"
                                                    ...
                                                    onClick={localStorage.getItem("ERP_ROLE") !== PLAN ? () => navigate("/piping/user/packing-list") : handlePackingSubmit}>{state?.type === 'edit' ? localStorage.getItem("ERP_ROLE") !== PLAN ? "Back" : "Update" : "Submit"}</button>
                                                <button type="button"
