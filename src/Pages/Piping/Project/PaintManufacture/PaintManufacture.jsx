...
const PaintManufacture = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            if (disable === true) {
                dispatch(getUserPaintManufacturePiping({ status: '' }));
                setDisable(false);
            }
        }
        fetchData();
    ...
    const entity = useSelector((state) => state?.getUserPaintManufacturePiping?.user?.data);
    ...
    const handleDelete = (id, title) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const myurl = `${V_URL}/user/delete-paint-manufacturer-piping`;
                                                    ...
                                                    <div className="doctor-table-blk">
                                                        ...
                                                        <div className="doctor-search-blk">
                                                            ...
                                                            <div className="add-group">
                                                                <PaintAuth>
                                                                    <Link to="/piping/user/manage-paint-manufacture"
                                                                    ...
                                                                    <div className="dropdown dropdown-action">
                                                                        ...
                                                                        <div className="dropdown-menu dropdown-menu-end">
                                                                            <button type='button' className="dropdown-item"
                                                                                onClick={() => navigate('/piping/user/manage-paint-manufacture', { state: elem })}><i
