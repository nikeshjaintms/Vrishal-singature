...
const PipingClass = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      if (disable === true) {
        dispatch(getUserPipingClassMaster({ status: '' }));
        setDisable(false);
      }
    }
    fetchData();
  ...
  const entity = useSelector((state) => state?.getUserPipingClassMaster?.user?.data);
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        // const myurl = `${V_URL}/user/delete-request`;
         const myurl = `${V_URL}/user/delete-piping-request?id=${id}`;
            ...
            <div className="row">
              <div className="col-sm-12">
                <ul className="breadcrumb">
                  ...
                  <li className="breadcrumb-item active">Piping Class List</li>
                </ul>
              </div>
            </div>
          </div>
                          ...
                          <div className="doctor-table-blk">
                            ...
                            <div className="doctor-search-blk">
                              ...
                              <div className="add-group">
                                {/* <WeldingAuth> */}
                                  <Link to="/piping/user/manage-piping-class"
                                  ...
                                  <div className="dropdown dropdown-action">
                                    ...
                                    <div className="dropdown-menu dropdown-menu-end">
                                      <button type='button' className="dropdown-item"
                                        onClick={() => navigate('/piping/user/manage-piping-class', { state: elem })}><i
                                          className="fa-solid fa-pen-to-square m-r-5"></i>
                                        Edit</button>
                                      <button type='button' className="dropdown-item"
                                      //  onClick={() => handleDelete(elem?._id, elem.name)} 
