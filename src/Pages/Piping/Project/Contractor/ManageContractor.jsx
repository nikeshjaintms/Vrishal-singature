        ...
        if (validation()) {
            ...
            axios({
                ...
                if (response.data.success === true) {
                    navigate('/piping/user/contractor-master-management')
                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                <ul className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item"><Link to="/piping/user/contractor-master-management">Contractor List</Link></li>
                                    <li className="breadcrumb-item"><i className="feather-chevron-right"></i></li>
