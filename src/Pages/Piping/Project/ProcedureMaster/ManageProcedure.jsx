...
const ManageProcedure = () => {
    ...
    const handleSubmit = () => {
        if (validation()) {
            setDisable(true);
            const myurl = `${V_URL}/user/manage-piping-procedure-specification`;
            ...
            axios({
                ...
                if (response.data.success === true) {
                    navigate('/piping/user/procedure-master-management')
                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                <ul className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item"><Link to="/piping/user/procedure-master-management">Procedure & Specification Master List</Link></li>
                                    <li className="breadcrumb-item"><i className="feather-chevron-right"></i></li>
