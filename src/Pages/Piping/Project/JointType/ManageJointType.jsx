...
const ManageJointType = () => {
    ...
    const handleSubmit = () => {
        ...
        setError('');
        setDisable(true);
        const myurl = `${V_URL}/user/manage-joint-type-piping`;
        ...
        axios({
            ...
            if (response.data.success === true) {
                navigate('/piping/user/joint-type-management')
                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                <ul className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item"><Link to="/piping/user/joint-type-management">Joint Type List</Link></li>
                                    <li className="breadcrumb-item"><i className="feather-chevron-right"></i></li>
