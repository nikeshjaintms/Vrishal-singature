...
import { JointAuth } from '../../../../Routes/Users/Auth/AuthGuard';
...
const JointType = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      if (disable === true) {
        dispatch(getUserJointTypePiping({ status: '' }));
        setDisable(false);
      }
    }
    fetchData();
  ...
  const entity = useSelector((state) => state?.getUserJointTypePiping?.user?.data);
  ...
  const handleDelete = (id, title) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        const myurl = `${V_URL}/user/delete-joint-type-piping`;
            ...
            <div className="row">
              <div className="col-sm-12">
                <ul className="breadcrumb">
                  ...
                  <li className="breadcrumb-item active">Joint Type List</li>
                </ul>
              </div>
            </div>
          </div>
                          ...
                          <div className="doctor-table-blk">
                            ...
                            <div className="doctor-search-blk">
                              ...
                              <div className="add-group">
                                <JointAuth>
                                  <Link to="/piping/user/manage-joint-type"
                                  ...
                                  <div className="dropdown dropdown-action">
                                    ...
                                    <div className="dropdown-menu dropdown-menu-end">
                                      <button type='button' className="dropdown-item"
                                        onClick={() => navigate('/piping/user/manage-joint-type', { state: elem })}><i
