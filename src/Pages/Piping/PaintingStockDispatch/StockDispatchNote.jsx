...
useEffect(() => {
  ...
  dispatch(getPipingStockDispatchNotes({
    page: currentPage,
    limit,
  ...
  const entity = useSelector((state) => state.getPipingStockDispatchNotes?.user?.data?.data);
  const pagination = useSelector((state) => state.getPipingStockDispatchNotes?.user?.data?.pagination);
  ...
  const handleDownload = (options) => {
    ...
    PdfDownloadErp({ apiMethod: 'post', url: 'piping-download-multi-stock-dispatch', body: bodyFormData });
  }
            ...
            <div className="row">
              <div className="col-sm-12">
                <ul className="breadcrumb">
                  ...
                  <li className="breadcrumb-item active">Stock Dispatch Note- PAINTING</li>
                </ul>
              </div>
            </div>
          </div>
                      ...
                      <div className="row align-items-center">
                        <div className="col">
                          <div className="doctor-table-blk">
                            <h3>Stock Dispatch Note Records List</h3>
                            <div className="doctor-search-blk">
                              ...
                              <div className="add-group">
                                {localStorage.getItem('ERP_ROLE') === PLAN && (
                                  <Link to="/piping/user/manage-stock-dispatch-note"
                              ...
                              <td className="text-end">
                                <div className="dropdown dropdown-action">
                                  ...
                                  <div className="dropdown-menu dropdown-menu-end">
                                    <button type='button' className="dropdown-item" onClick={() => navigate('/piping/user/view-stock-dispatch-note', { state: elem })}><i className="fa-solid fa-eye m-r-5"></i>
                                      View</button>
