            ...
            <div className="row">
              <div className="col-sm-12">
                <ul className="breadcrumb">
                  ...
                  <li className="breadcrumb-item"><Link to="/piping/user/mio-clearance-management">MIO Clearance List</Link></li>
                  <li className="breadcrumb-item"><i className="feather-chevron-right"></i></li>
                  ...
                  <div className="col-12">
                    <div className="doctor-submit text-end">
                      {!data?._id ? (
                        ...
                        <button className="btn btn-primary" type='button' onClick={() => navigate('/piping/user/mio-clearance-management')}>
                          Back
                        </button>
                      )}
                    </div>
