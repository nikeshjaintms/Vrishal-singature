    ...
    useEffect(() => {
        ...
        if (paintData) {
            updatedSurface = {
                ...
                paintManufacturer: paintData.paint_manufacturer || '',
                            ...
                            <div className="row mt-4">
                                ...
                                <div className="col-md-4">
                                    <div className="input-block local-forms">
                                        ...
                                        <input type='text' className='form-control' onChange={handleChange}
                                            value={surface.paintSystemNo} readOnly={is_inspection} disabled />
                                    </div>
                                </div>
                                <div className="col-md-4">
                                    <div className="input-block local-forms">
                            ...
                            <div className="row mt-4">
                                ...
                                <div className="col-md-4">
                                    <div className="input-block local-forms">
                                        ...
                                        <input className='form-control' type='text' onChange={handleChange}
                                            value={surface.prepStandard} name='prepStandard' readOnly={is_inspection} disabled />
                                    </div>
                                </div>
                                <div className="col-md-4">
                                    <div className="input-block local-forms">
                                ...
                                <div className="col-md-4">
                                    <div className="input-block local-forms">
                                        ...
                                        <input className='form-control' type='text' onChange={handleChange}
                                            value={surface.surfaceProfile} readOnly={is_inspection} disabled />
                                    </div>
                                </div>
                                <div className="col-md-4">
                                    <div className="input-block local-forms">
                                ...
                                <div className="col-md-4">
                                    <div className="input-block local-forms">
                                        ...
                                        <input className='form-control' onChange={handleChange}
                                            value={surface?.saltTest} readOnly={is_inspection} disabled />
                                    </div>
                                </div>
                                {is_inspection && (
                                    <div className="col-md-4">
                            ...
                            <div className="row mt-4">
                                <div className="col-md-4">
                                    <div className="input-block local-forms">
                                        ...
                                        <input className='form-control' type='text' onChange={handleChange}
                                            value={surface.primerPaint} readOnly={is_inspection} disabled />
                                    </div>
                                </div>
                                <div className="col-md-4">
                                    <div className="input-block local-forms">
                                        ...
                                        <input className='form-control' type='text' onChange={handleChange}
                                            value={surface.appMethod} readOnly={is_inspection} disabled />
                                    </div>
                                </div>
                                <div className="col-md-4">
                                    <div className="input-block local-forms">
                                ...
                                <div className="col-md-4">
                                    <div className="input-block local-forms">
                                        ...
                                        <input className='form-control' type='text' onChange={handleChange}
                                            value={surface.paintManufacturer} readOnly={is_inspection} disabled />
                                    </div>
                                </div>
                                <div className="col-md-4">
                                    <div className="input-block local-forms">
                                        ...
                                        <input className='form-control' type='text' onChange={handleChange}
                                            value={surface.dftRange} readOnly={is_inspection} disabled />
                                    </div>
                                </div>
                                <div className="col-md-4">
                                    <div className="input-block local-forms">
