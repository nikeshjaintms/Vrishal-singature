                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                <ul className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item"><Link to="/piping/user/surface-clearance-management">Surface & Primer Clearance List</Link></li>
                                    <li className="breadcrumb-item"><i className="feather-chevron-right"></i></li>
                                ...
                                <div className="card-body">
                                    <div className="doctor-submit text-end">
                                        {!data?._id ? (
                                            ...
                                            <button className="btn btn-primary" type='button' onClick={() => navigate('/piping/user/surface-clearance-management')}>
                                                Back
                                            </button>
                                        )}
                                    </div>
