    ...
    const commentsData = useMemo(() => {
        ...
        if (search) {
            computedComments = computedComments.filter(
                (request) =>
                    request.order?.orderNo?.toString()?.toLowerCase()?.includes(search?.toLowerCase())
            );
        }
                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                <ul className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active">Purchase Return List</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <div className="doctor-table-blk">
                                                        ...
                                                        <div className="doctor-search-blk">
                                                            ...
                                                            <div className="add-group">
                                                                <Link to="/erp/user/planner/manage-purchase-request"
                                                ...
                                                <tbody>
                                                    {commentsData?.map((elem, i) =>
                                                        <tr key={elem?._id}>
                                                            ...
                                                            <td>{elem?.approvedBy?.full_name}</td>
                                                            <td>{elem?.preparedBy?.full_name}</td>
                                                            ...
                                                            <td>
                                                                <div className="dropdown dropdown-action">
                                                                    ...
                                                                    <div className="dropdown-menu dropdown-menu-end">
                                                                        <button type='button' className="dropdown-item" onClick={() => navigate('/erp/user/planner/manage-purchase-request', { state: elem })}><i
