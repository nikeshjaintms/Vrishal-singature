...
const TandC = () => {
  ...
  /* ---------------- Redux State ---------------- */
  const entity = useSelector((state) => state.terms?.list);
  const loading = useSelector((state) => state.terms?.loading || false);
  ...
  const handleDelete = async (id, title) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${V_URL}/user/terms-condition/delete-terms`,
        {id},
                          ...
                          <div className="doctor-table-blk">
                            ...
                            <div className="doctor-search-blk">
                              ...
                              <div className="add-group">
                                <Link to="/material-po/manage-terms-and-conditions" className="btn btn-primary add-pluss ms-2">
                                ...
                                <td className="text-end">
                                  <div className="dropdown dropdown-action">
                                    ...
                                    <div className="dropdown-menu dropdown-menu-end">
                                      <button className="dropdown-item" onClick={() => navigate("/material-po/manage-terms-and-conditions", { state: term })}>
