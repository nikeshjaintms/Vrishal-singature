      ...
      dispatch(addItem(formData))
        .then((res) => {
          if (res.payload.success === true) {
            navigate('/material-po/section-details')
            ...
            <div className="row">
              <div className="col-sm-12">
                <ul className="breadcrumb">
                  ...
                  <li className="breadcrumb-item"><Link to="/material-po/section-details">Section Details List</Link></li>
                  <li className="breadcrumb-item"><i className="feather-chevron-right"></i></li>
                  <li className="breadcrumb-item active">{data?._id ? 'Edit' : 'Add'} Section Details</li>
                </ul>
              </div>
            </div>
          </div>
                  ...
                  <form>
                    <div className="col-12">
                      <div className="form-heading">
                        <h4>{data?._id ? 'Edit' : 'Add'} Section Details</h4>
                      </div>
                    </div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-12 col-md-4 col-xl-4">
                        <div className="input-block local-forms">
                          ...
                          <select className="form-control select"
                            value={item.unit} onChange={handleChange} name='unit'>
                      ...
                      <div className="col-12 col-md-4 col-xl-4">
                        <div className="input-block local-forms">
                          <label> Grade </label>
                          <input className="form-control" type="text"
                            onChange={handleChange} name='material_grade'
                      ...
                      <div className="col-12 col-md-4 col-xl-4">
                        <div className="input-block local-forms">
                          ...
                          <select className="form-control select"
                            value={item.in_location} onChange={handleChange} name='in_location'
                          >
...
export default ManageSectionDetail