...
const SectionDeatils = () => {
    ...
    useEffect(() => {
        if (disable === true) {
            dispatch(getAdminItem({ is_main: false }))
            setDisable(false);
        }
    }, [dispatch, disable]);
                                                    ...
                                                    <div className="doctor-table-blk">
                                                        ...
                                                        <div className="doctor-search-blk">
                                                            ...
                                                            <div className="add-group">
                                                                    <Link to={PO_ROUTE_URLS.MANAGE_SECTION_DETAILS}
                                                                ...
                                                                <td className="text-end">
                                                                    <div className="dropdown dropdown-action">
                                                                        ...
                                                                        <div className="dropdown-menu dropdown-menu-end">
                                                                            <button type='button' className="dropdown-item" onClick={() => navigate('/material-po/manage-section-details', { state: elem })}><i
