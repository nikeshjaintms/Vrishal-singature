  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await axios.post(
        `${V_URL}/user/terms-condition/manage-terms-piping`,
        payload
      );

      if (res.data.success) {
        navigate(PO_ROUTE_URLS.PIPING_TERMS_AND_CONDITIONS);
      }
    } catch (err) {
      ...
      <div className="content">
        <div className="page-header">
          <ul className="breadcrumb">
            ...
            <li className="breadcrumb-item"><Link to={PO_ROUTE_URLS.PIPING_TERMS_AND_CONDITIONS}>Terms and Condition</Link></li>
            <li className="breadcrumb-item"><i className="feather-chevron-right" /></li>
...
export default PipingManageTerms;
