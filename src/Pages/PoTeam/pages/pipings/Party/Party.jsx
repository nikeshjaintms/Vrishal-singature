...
/>
                              ...
                              <div className="add-group">
                                  <Link to="/material-po/manage-manufacturer"
                                ...
                                <td className="text-end">
                                  <div className="dropdown dropdown-action">
                                    ...
                                    <div className="dropdown-menu dropdown-menu-end">
                                      <button type='button' className="dropdown-item" onClick={() => navigate('/material-po/manage-manufacturer', { state: elem })}><i
