...
const PipingManageParty = () => {
  ...
  useEffect(() => {
    if (location.state) {
      setParty({
        ...
        store_type: location.state?.store_type,
      });
  ...
  const handleSubmit = () => {
    if (validation()) {
      ...
      formData.append("pincode", party.pincode === null ? 0 : party.pincode);
      ...
      formData.append("store_type", party.store_type);
      ...
      dispatch(addParty(formData))
        .then((res) => {
          if (res.payload.success === true) {
            navigate(PO_ROUTE_URLS.PIPING_MANUFACTURE_LIST);
            handleReset();
          }
          setDisable(false);
        })
            ...
            <div className="row">
              <div className="col-sm-12">
                <ul className="breadcrumb">
                  ...
                  <li className="breadcrumb-item">
                    <Link to={PO_ROUTE_URLS.PIPING_MANUFACTURE_LIST}>Stack Holder List</Link>
                  </li>
                  <li className="breadcrumb-item">
                    <i className="feather-chevron-right"></i>
                  </li>
                  <li className="breadcrumb-item active">
                    {data?._id ? "Edit" : "Add"} Stack Holder
                  </li>
                </ul>
              </div>
            </div>
                  ...
                  <form>
                    <div className="col-12">
                      <div className="form-heading">
                        <h4>{data?._id ? "Edit" : "Add"} Stack Holder Details</h4>
                      </div>
                    </div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-12 col-md-4 col-xl-4">
                        <div className="input-block local-forms">
                          ...
                          <input className="form-control" onChange={handleChange}
                            name="address_two" value={party.address_two} />
                        </div>
                      </div>
                      ...
                      <div className="col-12 col-md-4 col-xl-4">
                        <div className="input-block local-forms">
                          ...
                          <input className="form-control" onChange={handleChange}
                            name="address_three" value={party.address_three} />
                        </div>
                      </div>
                      ...
                      <div className="col-12 col-md-4 col-xl-4">
                        <div className="input-block local-forms">
                          ...
                          <select className="form-select"
                            onChange={handleChange} name="party_tag" value={party.party_tag}>
                      ...
                      <div className="col-12 col-md-4 col-xl-4">
                        <div className="input-block local-forms">
                          <label>Store</label>
                          <select className="form-select"
                            onChange={handleChange} name='store_type' value={party.store_type}>
...
export default PipingManageParty;
