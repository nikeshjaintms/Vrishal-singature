...
import { getAllOrders } from '../../../../Store/PoTeam/Order/Order';
...
const Order = () => {
  ...
  const handleDeleteOrder = async (id, poNo) => {
    ...
    try {
      ...
      const response = await axios.delete(`${V_URL}/user/order/delete-order`, {
  ...
  const handleDownloadPDF = async (id) => {
    try {
      ...
      const response = await axios.post(
        `${V_URL}/user/order/download-order-pdf`,
        { id, project_id },
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const handleDownloadExcel = async (id) => {
    try {
      ...
      const response = await axios.post(
        `${V_URL}/user/order/download-order-excel`,
        { id, project_id },
        {
          headers: {
...
const handleSendOrders = async () => {
  try {
    ...
    const response = await axios.post(
      `${V_URL}/user/order/send-to-material`,
                          ...
                          <div className="doctor-table-blk">
                            ...
                            <div className="doctor-search-blk">
                              ...
                              <div className="add-group">
                                ...
                                <Link to="/material-po/manage-order" className="btn btn-primary add-pluss ms-2">
                                ...
                                <td className="text-end">
                                  <div className="dropdown dropdown-action">
                                    ...
                                    <div className="dropdown-menu dropdown-menu-end">
                                      <button className="dropdown-item" onClick={() => navigate("/material-po/view-order", { state: row })}>
                                     ...
                                     {localStorage.getItem('PO_ROLE') === "Procurement" &&
                                        ...
                                        (
                                          <button
                                            ...
                                            onClick={() =>
                                              navigate("/material-po/manage-order", { state: row })
                                            }
                                          >
                    ...
                    <div className="row align-center mt-3 mb-2">
                      <div className="col-sm-12 col-md-6">
                        <div className="dataTables_info">
                          Showing {Math.min(limit, totalItems)} from {totalItems} entries
                        </div>
                      </div>
