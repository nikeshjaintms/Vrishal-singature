...
const ManagePurchaseOrder = () => {
  ...
  useEffect(() => {
    if (location.state) {
      setPurchaseOrder({
        ...
        projectName: location.state?.project._id || null,
  ...
  const projects = useSelector((state) => state?.getUserProfile?.user?.data); // for the assigned project
  const employee = useSelector((state) => state?.getStoreEmployee?.user?.data);
  const stores = useSelector((state) => state?.getLocation?.user?.data);

  // const partyData = supplierParties?.filter(
  //   (elem) => elem.partyGroup.name === "Supplier"
  // ) || [];
  ...
  const handleSubmit = () => {
    if (FormValidation()) {
      ...
      bodyFormData.append('project', purchaseOrder.projectName);
      bodyFormData.append('tag', '1');
            ...
            <div className="row">
              <div className="col-sm-12">
                <ul className="breadcrumb">
                  ...
                  <li className="breadcrumb-item">
                    <Link to="/product-store/user/purchase-order-management">
                      Purchase Order
                    </Link>
                  </li>
                  <li className="breadcrumb-item">
                        ...
                        <div className="card-body">
                          <div className="col-12 text-end">
                            <div className="doctor-submit text-end">
                              <button type="button"
                                className="btn btn-primary submit-form me-2" onClick={handleSubmit} disabled={disable || disable3}> {disable ? 'Processing...' : 'Save and Continue'}</button>
                              <button type="button"
                ...
                <div className="card">
                  <div className="card-body">
                    <div className="col-12 text-end">
                      <div className="doctor-submit text-end">
                        <button type="button"
                          className="btn btn-primary submit-form me-2" onClick={() => navigate('/product-store/user/purchase-order-management')}>Back</button>
                      </div>
                    </div>
                  </div>
                </div>
