                          ...
                          <div className="doctor-table-blk">
                            ...
                            <div className="doctor-search-blk">
                              ...
                              <div className="add-group">
                                <Link
                                  to="/product-store/user/manage-purchase-order"
                                ...
                                elem.items.map((e) => (
                                  <tr key={e?._id}>
                                    ...
                                    <td>{e?.balance_qty !== 0 && e?.with_po === true ? (
                                      <a style={{ cursor: "pointer" }} onClick={() => handleEdit(elem, e)}>  <Download /></a>
                                    ) : <X />}
                                    </td>
                                      ...
                                      <div className="dropdown dropdown-action">
                                        ...
                                        <div className="dropdown-menu dropdown-menu-end">
                                          <button
                                            ...
                                            onClick={() =>
                                              navigate("/product-store/user/manage-purchase-order", {
                                                state: elem,
                                              })
                                            }
                                          >
                                    ...
                                    <div className="dropdown dropdown-action">
                                      ...
                                      <div className="dropdown-menu dropdown-menu-end">
                                        <button
                                          type="button"
                                          className="dropdown-item"
                                          onClick={() => navigate("/product-store/user/manage-purchase-order", { state: elem, })} >
                                          <i className="fa-solid fa-pen-to-square m-r-5"></i>
                                          Edit
                                        </button>
