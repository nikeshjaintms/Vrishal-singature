...
const Item = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            if (disable === true) {
                try {
                    await dispatch(getAdminItem({ is_main: true }))
                    setDisable(false);
                } catch (error) {
                    setDisable(false);
                }
        ...
        if (search) {
            computedComments = computedComments.filter(
                (it) =>
                    ...
                    it.unit.name?.toLowerCase()?.includes(search?.toLowerCase()) ||
                    it.hsn_code?.toString()?.toLowerCase()?.includes(search?.toLowerCase()) ||
                    it.reorder_quantity?.toString()?.toLowerCase()?.includes(search?.toLowerCase())
            );
        }
                                                    ...
                                                    <div className="doctor-table-blk">
                                                        ...
                                                        <div className="doctor-search-blk">
                                                            ...
                                                            <div className="add-group">
                                                                <Link to="/product-store/user/manage-item"
                                                            ...
                                                            <td className="text-end">
                                                                <div className="dropdown dropdown-action">
                                                                    ...
                                                                    <div className="dropdown-menu dropdown-menu-end">
                                                                        <button type='button' className="dropdown-item" onClick={() => navigate('/product-store/user/manage-item', { state: elem })}><i
