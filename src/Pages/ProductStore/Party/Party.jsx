...
const Party = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      if (disable === true) {
        try {
          await dispatch(getAdminParty({ storeType: '2', is_main: false }))
          setDisable(false);
        } catch (error) {
          setDisable(false);
        }
  ...
  const entity = useSelector((state) => state?.getAdminParty?.user?.data?.data);
                          ...
                          <div className="doctor-table-blk">
                            ...
                            <div className="doctor-search-blk">
                              ...
                              <div className="add-group">
                                <Link to="/product-store/user/manage-party"
                        ...
                        <tbody>
                          {commentsData?.map((elem, i) =>
                            <tr key={elem?._id}>
                              ...
                              <td>{elem?.address}-{elem?.pincode},{elem?.city},{elem?.state}</td>
                              ...
                              <td className="text-end">
                                <div className="dropdown dropdown-action">
                                  ...
                                  <div className="dropdown-menu dropdown-menu-end">
                                    <button type='button' className="dropdown-item" onClick={() => navigate('/product-store/user/manage-party', { state: elem })}><i
