      ...
      dispatch(addPartyGroup(formData))
        .then((res) => {
          ...
          if (res.payload.success === true) {
            navigate('/product-store/user/party-group-management');
            setPartyGroup('');
          }
          setDisable(false)
        }).catch((error) => {
            ...
            <div className="row">
              <div className="col-sm-12">
                <ul className="breadcrumb">
                  ...
                  <li className="breadcrumb-item"><Link to="/product-store/user/party-group-management">Party Group List</Link></li>
                  <li className="breadcrumb-item"><i className="feather-chevron-right"></i></li>
