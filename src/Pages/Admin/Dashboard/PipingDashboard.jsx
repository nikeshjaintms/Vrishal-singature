...
const PipingDashboard = ({ pId }) => {
    ...
    const getPipingDaashboard = () => {
        const myUrl = `${V_URL}/admin/get-piping-dashboard`;
    ...
    const cardData = [
      ...
      { title: "RT ACCEPTANCE", lastDay: pmsData?.lastDayRtNdt, overall: pmsData?.overallRtNdt, icon: "/assets/img/icons/calendar.svg" },

{ title: "FT ACCEPTANCE", lastDay: pmsData?.lastDayFtNdt, overall: pmsData?.overallFtNdt, icon: "/assets/img/icons/calendar.svg" },

{ title: "PWHT ACCEPTANCE", lastDay: pmsData?.lastDayPwhtNdt, overall: pmsData?.overallPwhtNdt, icon: "/assets/img/icons/calendar.svg" },

{ title: "LPT ACCEPTANCE", lastDay: pmsData?.lastDayLptNdt, overall: pmsData?.overallLptNdt, icon: "/assets/img/icons/calendar.svg" },

{ title: "MPT ACCEPTANCE", lastDay: pmsData?.lastDayMptNdt, overall: pmsData?.overallMptNdt, icon: "/assets/img/icons/calendar.svg" },

{ title: "HT ACCEPTANCE", lastDay: pmsData?.lastDayHtNdt, overall: pmsData?.overallHtNdt, icon: "/assets/img/icons/calendar.svg" },

{ title: "PMI ACCEPTANCE", lastDay: pmsData?.lastDayPmiNdt, overall: pmsData?.overallPmiNdt, icon: "/assets/img/icons/calendar.svg" },

{ title: "PICKLING ACCEPTANCE", lastDay: pmsData?.lastDayPicklingNdt, overall: pmsData?.overallPicklingNdt, icon: "/assets/img/icons/calendar.svg" },
...
export default PipingDashboard