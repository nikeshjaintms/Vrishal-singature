...
const Client = () => {
    ...
    const getClient = () => {
        const myurl = `${V_URL}/admin/get-admin-party`;
...
axios({
  method: "post",
  url: `${V_URL}/admin/get-admin-party`,
  data: {
    is_admin: true,
    currentPage,
    limit,
    ...
    const handleDelete = (id, title) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const myurl = `${V_URL}/admin/delete-party`;
                                                            ...
                                                            <td className="text-end">
                                                                <div className="dropdown dropdown-action">
                                                                    ...
                                                                    <div className="dropdown-menu dropdown-menu-end">
                                                                        <button type='button' className="dropdown-item" onClick={() => navigate('/admin/manage-client', { state: elem })}><i
