...
import { getAdminAuth } from '../../../Store/Admin/Payroll/AuthPerson/AdminAuthPerson';
...
const AuthPerson = () => {
    ...
    const entity = useSelector((state) => state?.getAdminAuth?.user?.data);
    ...
    const handleDelete = (id, title) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const myurl = `${V_URL}/admin/delete-project`;
                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                <ul className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active">Auth People List</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <div className="doctor-table-blk">
                                                        ...
                                                        <div className="doctor-search-blk">
                                                            ...
                                                            <div className="add-group">
                                                                <Link to="/admin/manage-auth-people"
                                                            ...
                                                            <td className="text-end">
                                                                <div className="dropdown dropdown-action">
                                                                    ...
                                                                    <div className="dropdown-menu dropdown-menu-end">
                                                                        <button type='button' className="dropdown-item" onClick={() => navigate('/admin/manage-auth-people', { state: elem })}><i
