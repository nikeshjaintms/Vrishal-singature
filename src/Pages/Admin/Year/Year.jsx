...
const Year = () => {
  ...
  const commentsData = useMemo(() => {
    ...
    if (search) {
      computedComments = computedComments.filter(
        (year) =>
          year.start_year?.toString()?.toLowerCase()?.includes(search?.toLowerCase()) ||
          year.end_year?.toString()?.toLowerCase()?.includes(search?.toLowerCase())
      );
    }
  ...
  const handleDelete = (id, start, end) => {
    Swal.fire({
      title: `Are you sure want to delete ${start}-${end}?`,
      ...
      if (result.isConfirmed) {
        ...
        const myurl = `${V_URL}/admin/delete-year`;
            ...
            <div className="row">
              <div className="col-sm-12">
                <ul className="breadcrumb">
                  ...
                  <li className="breadcrumb-item active">Year List</li>
                </ul>
              </div>
            </div>
          </div>
                        ...
                        <tbody>
                          {commentsData.map((elem, i) =>
                            <tr key={elem?._id}>
                              ...
                              <td>{moment(elem?.start_year).format('YYYY')}-{moment(elem?.end_year).format('YYYY')}</td>
                              ...
                              <td className="text-end">
                                <div className="dropdown dropdown-action">
                                  ...
                                  <div className="dropdown-menu dropdown-menu-end">
                                    <button type='button' className="dropdown-item" onClick={() => navigate('/admin/manage-year', { state: elem })}><i
                                      className="fa-solid fa-pen-to-square m-r-5"></i>
                                      Edit</button>
                                    <button type='button' className="dropdown-item" onClick={() => handleDelete(elem?._id, moment(elem.start_year).format('YYYY'), moment(elem.end_year).format('YYYY'))} ><i
