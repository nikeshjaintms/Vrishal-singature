...
import { getAdminPU } from '../../../../Store/Admin/Transaction/GetAdminPurchaseRecieving';

const PurchaseRecieving = () => {
    ...
    const fetchData = () => {
        ...
        dispatch(getAdminPU({ formData: bodyFormData }))
        setDisable(false);
    };
    ...
    const entity = useSelector((state) => state?.getAdminRecieving?.user?.data);
                                                            ...
                                                            <td className="text-end">
                                                                <div className="dropdown dropdown-action">
                                                                    ...
                                                                    <div className="dropdown-menu dropdown-menu-end">
                                                                        <button type='button' className="dropdown-item" onClick={() => navigate(`/admin/view-purchase-recieving`, { state: elem })}><i
...
export default PurchaseRecieving