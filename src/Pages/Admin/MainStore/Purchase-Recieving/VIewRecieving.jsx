...
import { getOnePU } from "../../../../Store/Admin/Transaction/GetOnePurchaseRecieving";
...
const VIewRecieving = () => {
    ...
    useEffect(() => {
        ...
        if (disable === true) {
            dispatch(getOnePU({ id: data._id }))
            setDisable(false)
        }
        dispatch(getItem());
    }, [navigate, disable]);

    const getSinglePurchase = useSelector((state) => state?.getSinglePU?.user?.data)
                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                <ul className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item">
                                        <Link to="/admin/purchase-recieving">
                                            Purchase Recieving
                                        </Link>
                                    </li>
                                    <li className="breadcrumb-item">
                                    ...
                                    <div className="col-12 text-end">
                                        <div className="doctor-submit text-end">
                                            <button
                                                ...
                                                onClick={() => navigate('/admin/purchase-recieving')}
                                            >
                                                Back
                                            </button>
                                        </div>
