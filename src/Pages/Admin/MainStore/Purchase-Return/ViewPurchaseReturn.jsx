...
import { getOnePUR } from "../../../../Store/Admin/Transaction/GetOnePurchaseReturn";
...
const ViewPurchaseReturn = () => {
    ...
    useEffect(() => {
        ...
        if (disable === true) {
            dispatch(getOnePUR({ id: data._id }))
            setDisable(false)
        }
        dispatch(getItem());
    }, [navigate, disable]);

    const getSinglePurchase = useSelector((state) => state?.getSinglePUR?.user?.data)
                                    ...
                                    <div className="col-12 text-end">
                                        <div className="doctor-submit text-end">
                                            <button
                                                ...
                                                onClick={() => navigate('/admin/purchase-return')}
                                            >
                                                Back
                                            </button>
                                        </div>
