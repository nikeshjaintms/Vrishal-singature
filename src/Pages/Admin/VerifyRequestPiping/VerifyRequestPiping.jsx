...
const paginatedData = useMemo(() => {
    ...
    const getRequest = () => {
        const myurl = `${V_URL}/admin/get-request-data-to-admin-piping`;
    ...
    const handleDownload = (elem) => {
        ...
        const myurl = `${V_URL}/admin/get-store-request-item-piping`;
        axios({
            method: "post",
            url: myurl,
            data: bodyFormData,
    ...
    const handleApprove = (id, no, status) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                const myurl = `${V_URL}/admin/verify-request-piping`;
                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                <ul className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active">Piping Material PO NO List</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div className="row align-items-center">
                                                <div className="col">
                                                    <div className="doctor-table-blk">
                                                        <h3>Piping Material PO NO List</h3>
                                                        ...
                                                        <tr key={i}>
                                                            ...
                                                            <td>
                                                                {elem.status === 1 ? (
                                                                    ...
                                                                    <span className="custom-badge status-red">Rejected By Admin</span>
                                                                ) :<span>Unknown</span>}
                                                            </td>
                                                            ...
                                                            <td className="text-end">
                                                                <div className="dropdown dropdown-action">
                                                                    ...
                                                                    <div className="dropdown-menu dropdown-menu-end">
                                                                        <button type='button' className="dropdown-item" onClick={() => navigate('/admin/view-request-piping', { state: elem })}>
