...
import { getAdminItemPipingData } from '../../../Store/Admin/ItemPiping/getAdminItemPiping';
...
const ViewRequest = () => {
    ...
    useEffect(() => {
        ...
        dispatch(getAdminItemPipingData());
    }, [navigate, dispatch]);

    const itemData = useSelector((state) => state?.getAdminItemPipingData?.user?.data);
                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                <ul className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item"><Link to="/admin/verify-request-management-piping">Piping Material PO NO List </Link></li>
                                    <li className="breadcrumb-item"><i className="feather-chevron-right"></i></li>
                                    <li className="breadcrumb-item active">View Piping Material PO NO</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="card-body">
                                    <div className="col-12">
                                        <div className="form-heading">
                                            <h4>View Piping Material PO NO Details</h4>
                                        </div>
                                    </div>
                                    <div className='row'>
                                        {[
