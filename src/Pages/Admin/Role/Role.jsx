...
const Role = () => {
  ...
  //       const myurl = `${V_URL}/admin/delete-erprole`;
                              ...
                              <td className="text-end">
                                <div className="dropdown dropdown-action">
                                  ...
                                  <div className="dropdown-menu dropdown-menu-end">
                                    <button type='button' className="dropdown-item" onClick={() => navigate('/admin/manage-erprole', { state: elem })}><i
