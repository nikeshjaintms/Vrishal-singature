...
const Contractor = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            if (disable === true) {
                dispatch(AdminContractorMaster({ status: '' }));
                setDisable(false);
            }
        }
        fetchData();
    ...
    const entity = useSelector((state) => state?.getAdminContractor?.user?.data);
    ...
    const handleDelete = (id, title) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const myurl = `${V_URL}/admin/delete-contractor`;
                                                    ...
                                                    <div className="doctor-table-blk">
                                                        ...
                                                        <div className="doctor-search-blk">
                                                            ...
                                                            <div className="add-group">
                                                                <Link to="/admin/manage-contractor"
                                                                ...
                                                                <div className="dropdown dropdown-action">
                                                                    ...
                                                                    <div className="dropdown-menu dropdown-menu-end">
                                                                        <button type='button' className="dropdown-item"
                                                                            onClick={() => navigate('/admin/manage-contractor', { state: elem })}><i
