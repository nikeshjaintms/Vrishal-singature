        ...
        if (search) {
            ...
            computedComments = computedComments.filter(
                (pro) =>
                    ...
                    pro.location?.name?.toLowerCase()?.includes(search?.toLowerCase()) // ||
                    // pro.label?.labelId?.projectTypeName?.toLowerCase()?.includes(search?.toLowerCase())
            );
        }
                                                ...
                                                <tbody>
                                                    {commentsData.map((elem, i) =>
                                                        <tr key={elem?._id}>
                                                            ...
                                                            <td>{elem?.name}</td>
                                                            {/* <td>{elem?.location}</td> */}
                                                            <td>{elem?.projectManager?.name}</td>
                                                            ...
                                                            <td className="text-end">
                                                                <div className="dropdown dropdown-action">
                                                                    ...
                                                                    <div className="dropdown-menu dropdown-menu-end">
                                                                        <button type='button' className="dropdown-item" onClick={() => navigate('/admin/manage-project', { state: elem })}><i
