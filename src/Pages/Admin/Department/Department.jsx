...
import { getAdminDepartment } from '../../../Store/Admin/Payroll/Department/AdminDepartment';
...
const Department = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            if (disable === true) {
                try {
                    await dispatch(getAdminDepartment())
                    setDisable(false);
                } catch (error) {
                    setDisable(false);
                }
    ...
    const entity = useSelector((state) => state?.getAdminDepartment?.user?.data);
    ...
    const commentsData = useMemo(() => {
        ...
        if (search) {
            ...
            computedComments = computedComments.filter(
                ...
                department.group.name?.toLowerCase()?.includes(search?.toLowerCase())
    ...
    const handleDelete = (id, title) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const myurl = `${V_URL}/admin/delete-department`;
                                                            ...
                                                            <td className="text-end">
                                                                <div className="dropdown dropdown-action">
                                                                    ...
                                                                    <div className="dropdown-menu dropdown-menu-end">
                                                                        <button type='button' className="dropdown-item" onClick={() => navigate('/admin/manage-department', { state: elem })}><i
