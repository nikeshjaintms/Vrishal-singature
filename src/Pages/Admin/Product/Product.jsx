...
const Product = () => {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      const myurl = `${V_URL}/admin/delete-product`;

      axios.delete(myurl, {
        data: { id },       // <-- clean, backend-friendly
        headers: { 
          "Content-Type": "application/json",
          Authorization: `Bearer ${localStorage.getItem('VA_TOKEN')}`  // <-- space added
        }
      })
      .then((response) => {
        if (response.data.success) {
                  ...
                  <div className="card-body">
                              ...
                              <td className="text-end">
                                <div className="dropdown dropdown-action">
                                  ...
                                  <div className="dropdown-menu dropdown-menu-end">
                                    <button type='button' className="dropdown-item" onClick={() => navigate('/admin/manage-product', { state: elem })}><i
                    ...
                    <div className="row align-center mt-3 mb-2">
                      <div className="col-sm-12 col-md-6 col-lg-6 col-xxl-6">
                        <div className="dataTables_info" id="DataTables_Table_0_info" product="status"
