...
const ProcurementRequestItemModal = ({
  show,
  handleClose,
  handleSaveModal,
  editData,
    ...
    <Modal show={show} onHide={handleClose} size="xl" backdrop="static" centered>
      ...
      <Modal.Body>
        ...
        <div className="row g-3">         
          ...
          <div className="col-md-6">
            <label>Item length to be specified by Supplier</label>
            <input
              type="number"
              className="form-control"
              name="fabDrawingQty"
          ...
          <div className="col-md-6">
            <label>Offer Make/Manufacturer</label>
            <input
              type="text"
              className="form-control"
              name="material_grade"
...
export default ProcurementRequestItemModal;
