                        ...
                        <table className="table table-striped custom-table comman-table mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th>Off. Length(mm)</th>
                                    <th>Off. Width(mm)</th>
                                    <th>Off. Thickness (T/B)</th>
                                    <th>Off. Thickness (W)</th>
                                    <th>Off. Thickness (N)</th>
                                    <th>Heat/Lot No.</th>
                                    <th>Manufacturer</th>
                                    <th>Store Type</th>
                                    <th>Remarks</th>
                            ...
                            <tbody>
                                {data?.items?.map((e, i) =>
                                    <tr key={e?._id}>
                                        ...
                                        <td>{e?.transactionId?.itemName?.unit?.name}</td>
                                        <td>{e?.transactionId?.mcode}</td>
                                        <td>{e?.offeredQty || '-'}</td>
                                        <td>{e?.challan_qty || '-'}</td>
                                        <td>{e?.offerNos || '-'}</td>
                                        <td>{e?.offerLength || '-'}</td>
                                        <td>{e?.offerWidth || '-'}</td>
                                        <td>{e?.offer_topbottom_thickness || '-'}</td>
                                        <td>{e?.offer_width_thickness || '-'}</td>
                                        <td>{e?.offer_normal_thickness || '-'}</td>
                                        <td>{e?.lotNo}</td>
