...
const InquiryforSupplySectionTable = ({
  transactionData,
  handleSave,
  handleDelete,
  handleEdit,
  ...
  console.log("Inquiry for Supply Data in Table:", transactionData); // Debugging line
  return (
    <div className="card">
      <div className="card-body">
        <div className="col-12 d-flex justify-content-between align-items-center mb-4">
          <div className="form-heading">
            <h4>Inquiry for Supply List</h4>
          </div>
        ...
        {/* ) : (
          <p>
            No Inquiry for Supply records found. You can add new records by clicking the{" "}
...
export default InquiryforSupplySectionTable;
