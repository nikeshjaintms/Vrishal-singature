...
export const getAdminItemDetails = createAsyncThunk(
  ...
  async ({ is_main, currentPage, limit, search }) => {
    try {
      ...
      const myurl = `${V_URL}/user/get-admin-item-details?${queryParams.toString()}`;
...
const getAdminItemDetailsSlice = createSlice({
  name: "getAdminItemDetails",
  initialState: {
    user: null,
    loading: false,
    error: null,
...
export default getAdminItemDetailsSlice.reducer;
